...
namespace GraphicsModule
{
    ...
    static class PropertyLineProjections
    {
        ...
        public static void DrawTempPointProjection(PointOfPlan1X0Y projection, Graphics graphicsSource)
        {
            var drawPoint3DProectionsTemp = new PointDraw();
            ...
            drawPoint3DProectionsTemp.DrawPointProection(projection, Radius_PointProection, DrawOperations.GridDraw_Var.GridCenter, ref graphicsSource);
        }
        public static void DrawTempPointProjection(PointOfPlan2X0Z projection, Graphics graphicsSource)
        {
            var drawPoint3DProectionsTemp = new PointDraw();
        ...
        public static void DrawTempPointProjection(PointOfPlan3Y0Z projection, Graphics graphicsSource)
        {
            var drawPoint3DProectionsTemp = new PointDraw();
