...
namespace GraphicsModule.Rules.Create.Planes
{
    public class CreatePlaneOfPlane1X0Y : ICreate, ICreatePlanes
    {
        ...
        {
            return Analyze.LinesPositionExtensions.IsParallel(ln1, ln2) ? new PlaneOfPlane1X0Y(ln1, ln2) : null;
        }
        public PlaneOfPlane1X0Y CreateByCrossedLines(LineOfPlane1X0Y ln1, LineOfPlane1X0Y ln2, Point frameCenter)
        {
            return Analyze.LinesPositionExtensions.IsCrossed(ln1, ln2, frameCenter) ? new PlaneOfPlane1X0Y(ln1, ln2) : null;
        }
        ...
        {
            return Analyze.LinesPositionExtensions.IsParallel(sg1, sg2) ? new PlaneOfPlane1X0Y(sg1, sg2) : null;
        }
        public PlaneOfPlane1X0Y CreateByCrossedSegments(SegmentOfPlane1X0Y sg1, SegmentOfPlane1X0Y sg2, Point frameCenter)
        {
            return Analyze.LinesPositionExtensions.IsCrossed(sg1, sg2, frameCenter) ? new PlaneOfPlane1X0Y(sg1, sg2) : null;
        }
