...
namespace GeometryObjects
{
    ...
    public class PointDraw
    {
        ...
        {
            //Экземпляры переменных для отрисовки точек
            Point3DAxonometry_PositionByPicture = new System.Drawing.Point();
            PointPlan1X0Y_PositionByPicture = new System.Drawing.Point();
            PointPlan2X0Z_PositionByPicture = new System.Drawing.Point();
            PointPlan3Y0Z_PositionByPicture = new System.Drawing.Point();
            //Экземпляры переменных для отрисовки точек
            Point3D_Axonometry_PositionByFrame_Var = new System.Drawing.Point();
            PointPlan1X0Y_PositionByFrame = new System.Drawing.Point();
            PointPlan2X0Z_PositionByFrame = new System.Drawing.Point();
            PointPlan3Y0Z_PositionByFrame = new System.Drawing.Point();
        }
        ...
        /// <remarks></remarks>
        public PointDraw(Point3D Point3D_Source)
        {
            //Экземпляры переменных для отрисовки точек
            Point3DAxonometry_PositionByPicture = CnvPoint3D_ToAxonometryPoint(Point3D_Source);
            PointPlan1X0Y_PositionByPicture = CnvPoint3DProjection_ToPoint(Point3D_Source.PointOfPlan1X0Y);
            PointPlan2X0Z_PositionByPicture = CnvPoint3DProjection_ToPoint(Point3D_Source.PointOfPlan2X0Z);
            PointPlan3Y0Z_PositionByPicture = CnvPoint3DProjection_ToPoint(Point3D_Source.PointOfPlan3Y0Z);
            //Экземпляры переменных для отрисовки точек
            Point3D_Axonometry_PositionByFrame_Var = new System.Drawing.Point();
            PointPlan1X0Y_PositionByFrame = new System.Drawing.Point();
            PointPlan2X0Z_PositionByFrame = new System.Drawing.Point();
        ...
        /// <param name="Point3D_Source">Заданная 3D точка</param>
        /// <remarks></remarks>
        public PointDraw(Point3D Point3D_Source, System.Drawing.Point FrameCentre_Source)
        {
            //Экземпляры переменных для отрисовки точек
            Point3DAxonometry_PositionByPicture = CnvPoint3D_ToAxonometryPoint(Point3D_Source);
            PointPlan1X0Y_PositionByPicture = CnvPoint3DProjection_ToPoint(Point3D_Source.PointOfPlan1X0Y);
            ...
            Point3D_Axonometry_PositionByFrame_Var = PointPositionCorrection(Point3DAxonometry_PositionByPicture, Pen_Point3D_Axonometry.Width, FrameCentre_Source);


            PointPlan1X0Y_PositionByFrame = PointPositionCorrection(PointPlan1X0Y_PositionByPicture, Pen_Point1X0Y.Width, FrameCentre_Source);
            PointPlan2X0Z_PositionByFrame = PointPositionCorrection(PointPlan2X0Z_PositionByPicture, Pen_Point2X0Z.Width, FrameCentre_Source);
            PointPlan3Y0Z_PositionByFrame = PointPositionCorrection(PointPlan3Y0Z_PositionByPicture, Pen_Point3Y0Z.Width, FrameCentre_Source);
        }
        ...
        /// <param name="Point3D_Source">Заданная 3D точка</param>
        /// <remarks></remarks>
        public PointDraw(Point3D Point3D_Source, int PointX0Y_Diametre, int PointX0Z_Diametre, int PointY0Z_Diametre, System.Drawing.Point FrameCentre_Source)
        {
            //Экземпляры переменных для отрисовки точек
            Point3DAxonometry_PositionByPicture = CnvPoint3D_ToAxonometryPoint(Point3D_Source);
            PointPlan1X0Y_PositionByPicture = CnvPoint3DProjection_ToPoint(Point3D_Source.PointOfPlan1X0Y);
            ...
            //Скорректированные координаты точек отрисовки проекций 3D точки относительно положения заданной системы координат на изображении
            Point3D_Axonometry_PositionByFrame_Var = PointPositionCorrection(Point3DAxonometry_PositionByPicture, PointX0Y_Diametre, FrameCentre_Source);
            PointPlan1X0Y_PositionByFrame = PointPositionCorrection(PointPlan1X0Y_PositionByPicture, PointX0Y_Diametre, FrameCentre_Source);
            PointPlan2X0Z_PositionByFrame = PointPositionCorrection(PointPlan2X0Z_PositionByPicture, PointX0Z_Diametre, FrameCentre_Source);
            PointPlan3Y0Z_PositionByFrame = PointPositionCorrection(PointPlan3Y0Z_PositionByPicture, PointY0Z_Diametre, FrameCentre_Source);
        ...
        public PointDraw(PointOfPlan1X0Y PointOfPlan1_X0Y_Source, PointOfPlan2X0Z PointOfPlan2_X0Z_Source, PointOfPlan3Y0Z PointOfPlan3_Y0Z_Source)
        {
            ...
            {
                PointPlan1X0Y_PositionByPicture = CnvPoint3DProjection_ToPoint(PointOfPlan1_X0Y_Source);
                PointPlan1X0Y_PositionByFrame = new System.Drawing.Point();
            }
            if (PointOfPlan2_X0Z_Source != null)
            {
                PointPlan2X0Z_PositionByPicture = CnvPoint3DProjection_ToPoint(PointOfPlan2_X0Z_Source);
                PointPlan2X0Z_PositionByFrame = new System.Drawing.Point();
            }
            if (PointOfPlan3_Y0Z_Source != null)
            {
                PointPlan3Y0Z_PositionByPicture = CnvPoint3DProjection_ToPoint(PointOfPlan3_Y0Z_Source);
                PointPlan3Y0Z_PositionByFrame = new System.Drawing.Point();
            }
        }
        /// <summary>
        ...
        public PointDraw(PointOfPlan1X0Y pointOfPlan1X0YSource, PointOfPlan2X0Z pointOfPlan2X0ZSource, PointOfPlan3Y0Z pointOfPlan3Y0ZSource, Pen penPoint1X0Y, Pen penPoint2X0Z, Pen penPoint3Y0Z, Point frameCentreSource)
        {
            if (pointOfPlan1X0YSource != null)
            {
                ...
                PointPlan1X0Y_PositionByPicture = CnvPoint3DProjection_ToPoint(pointOfPlan1X0YSource);
                PointPlan1X0Y_PositionByFrame = PointPositionCorrection(PointPlan1X0Y_PositionByPicture, Pen_Point1X0Y.Width / 2, frameCentreSource);
            }
            if (pointOfPlan2X0ZSource != null)
            {
                Pen_Point2X0Z = penPoint2X0Z;
                PointPlan2X0Z_PositionByPicture = CnvPoint3DProjection_ToPoint(pointOfPlan2X0ZSource);
                PointPlan2X0Z_PositionByFrame = PointPositionCorrection(PointPlan2X0Z_PositionByPicture, Pen_Point2X0Z.Width / 2, frameCentreSource);
            }
            if (pointOfPlan3Y0ZSource != null)
            {
                Pen_Point3Y0Z = penPoint3Y0Z;
                PointPlan3Y0Z_PositionByPicture = CnvPoint3DProjection_ToPoint(pointOfPlan3Y0ZSource);
                PointPlan3Y0Z_PositionByFrame = PointPositionCorrection(PointPlan3Y0Z_PositionByPicture, Pen_Point3Y0Z.Width / 2, frameCentreSource);
            }
        }
        //---------------------------------- Свойства ----------------------------------------
        ...
        {//Свойство проекции 3D точки на плоскость X0Y
            get { return Point3DAxonometry_PositionByPicture_Var; }
            set { Point3DAxonometry_PositionByPicture_Var = value; }
        }
        ...
        {//Свойство точки рисования для горизонтальной проекции 3D точки 
            get { return PointPlan1X0Y_PositionByPicture_Var; }
            set { PointPlan1X0Y_PositionByPicture_Var = value; }
        }
        ...
        {//Свойство точки рисования для фронтальной проекции 3D точки 
            get { return PointPlan2X0Z_PositionByPicture_Var; }
            set { PointPlan2X0Z_PositionByPicture_Var = value; }
        }
        ...
        {//Свойство точки рисования для профильной проекции 3D точки 
            get { return PointPlan3Y0Z_PositionByPicture_Var; }
            set { PointPlan3Y0Z_PositionByPicture_Var = value; }
        }
        ...
        {//Свойство проекции 3D точки на плоскость X0Y
            get { return Point3D_Axonometry_PositionByFrame_Var; }
            set { Point3D_Axonometry_PositionByFrame_Var = value; }
        }
        ...
        {//Свойство точки рисования для горизонтальной проекции 3D точки 
            get { return PointPlan1X0Y_PositionByFrame_Var; }
            set { PointPlan1X0Y_PositionByFrame_Var = value; }
        }
        ...
        {//Свойство точки рисования для фронтальной проекции 3D точки 
            get { return PointPlan2X0Z_PositionByFrame_Var; }
            set { PointPlan2X0Z_PositionByFrame_Var = value; }
        }
        ...
        {//Свойство точки рисования для профильной проекции 3D точки 
            get { return PointPlan3Y0Z_PositionByFrame_Var; }
            set { PointPlan3Y0Z_PositionByFrame_Var = value; }
        }
        ...
        {//Свойство инструмента рисования аксонометрической проекции 3D точки 
            get { return Pen_Point3D_Axonometry_Var; }
            set { Pen_Point3D_Axonometry_Var = value; }
        }
        ...
        {//Свойство инструмента рисования горизонтальной проекции 3D точки 
            get { return Pen_Point1X0Y_Var; }
            set { Pen_Point1X0Y_Var = value; }
        }
        ...
        {//Свойство инструмента рисования фронтальной проекции 3D точки 
            get { return Pen_Point2X0Z_Var; }
            set { Pen_Point2X0Z_Var = value; }
        }
        ...
        {//Свойство инструмента рисования профильной проекции 3D точки 
            get { return Pen_Point3Y0Z_Var; }
            set { Pen_Point3Y0Z_Var = value; }
        }
        ...
        {//Свойство флага рисования горизонтальной проекции 3D точки 
            get { return FlagDraw_PointPlan1X0Y_Cls; }
            set { FlagDraw_PointPlan1X0Y_Cls = value; }
        }
        ...
        {//Свойство флага рисования фронтальной проекции 3D точки 
            get { return FlagDraw_PointPlan2X0Z_Cls; }
            set { FlagDraw_PointPlan2X0Z_Cls = value; }
        }
        ...
        {//Свойство флага рисования профильной проекции 3D точки 
            get { return FlagDraw_PointPlan3Y0Z_Cls; }
            set
            {
                FlagDraw_PointPlan3Y0Z_Cls = value;
            }
        }
        ...
        {//Свойство инструмента рисования вертикальной линии связи горизонтальной проекции 3D точки (направленной к оси X)
            get { return Pen_LinkLineXoY_toX_Cls; }
            set { Pen_LinkLineXoY_toX_Cls = value; }
        }
        ...
        {//Свойство инструмента рисования горизонтальной линии связи, дуги и вертикальной линии связи (для P3) горизонтальной проекции 3D точки (направленных к оси Y)
            get { return Pen_LinkLineXoY_toY_Cls; }
            set { Pen_LinkLineXoY_toY_Cls = value; }
        }
        ...
        {//Свойство инструмента рисования вертикальной линий связи фронтальной проекции 3D точки (направленной к оси X)
            get { return Pen_LinkLineXoZ_toX_Cls; }
            set { Pen_LinkLineXoZ_toX_Cls = value; }
        }
        ...
        {//Свойство инструмента рисования горизонтальной линий связи фронтальной проекции 3D точки (направленной к оси Z)
            get { return Pen_LinkLineXoZ_toZ_Cls; }
            set { Pen_LinkLineXoZ_toZ_Cls = value; }
        }
        ...
        {//Свойство инструмента рисования вертикальной линий связи профильной проекции 3D точки (направленной к оси Y)
            get { return Pen_LinkLineYoZ_toY_Cls; }
            set { Pen_LinkLineYoZ_toY_Cls = value; }
        }
        ...
        {//Свойство инструмента рисования горизонтальной линий связи профильной проекции 3D точки (направленной к оси Z)
            get { return Pen_LinkLineYoZ_toZ_Cls; }
            set { Pen_LinkLineYoZ_toZ_Cls = value; }
        }
        ...
        public System.Drawing.Point CnvPoint3DProjection_ToPoint(GeometryObjects.PointOfPlan1X0Y PointProjection)
        {
        ...
        /// <remarks>Для отрисовки точки начало системы координат определяется координатами X=0; Y=0 и расположено не в крайней или угловой точке изображения</remarks>
        public System.Drawing.Point CnvPoint3DProjection_ToPoint(PointOfPlan2X0Z PointProjection)
        {
        ...
        /// <remarks>Для отрисовки точки начало системы координат определяется координатами X=0; Y=0 и расположено не в крайней или угловой точке изображения</remarks>
        public System.Drawing.Point CnvPoint3DProjection_ToPoint(GeometryObjects.PointOfPlan3Y0Z PointProjection)
        {
        ...
        public System.Drawing.Point CnvPoint2D_ToPoint(Point2D Point2D_Source)
        {//Преобразует точку формата BaseGeometryYVP.GeomObjects.Point2D в System.Drawing.Point
        ...
        /// <remarks>Для отрисовки точки начало системы координат определяется координатами X=0; Y=0</remarks>
        public System.Drawing.PointF CnvPoint2D_ToPointF(Point2D Point2D_Source)
        {//Преобразует точку формата BaseGeometryYVP.GeomObjects.Point2D в System.Drawing.PointF
        ...
        /// <returns></returns>
        /// <remarks>Для отрисовки точки начало системы координат определяется координатами X=0; Y=0</remarks>
        public System.Drawing.Point CnvPoint3D_ToAxonometryPoint(Point3D Point3D_Source)
        ...
        /// <returns></returns>
        /// <remarks>Для отрисовки точки начало системы координат определяется координатами X=0; Y=0</remarks>
        public System.Drawing.PointF CnvPoint3D_ToAxonometryPointF(Point3D Point3D_Source)
        {//Преобразует точку формата BaseGeometryYVP.GeomObjects.Point(3D) в System.Drawing.PointF
        ...
        public GeometryObjects.PointOfPlan1X0Y CnvPoint_ToPointOfPlan1_X0Y(System.Drawing.Point Point_Source)
        {
            GeometryObjects.PointOfPlan1X0Y PointVar = new GeometryObjects.PointOfPlan1X0Y(-Point_Source.X, Point_Source.Y);
            return PointVar;
        }
        ...
        /// <remarks>Для отрисовки точки начало системы координат определяется координатами X=0; Y=0 и расположено не в крайней или угловой точке изображения. 
        /// Не проверяет корректность координат возвращаемой проекции точки для формирования 3D точки.</remarks>
        public PointOfPlan2X0Z CnvPoint_ToPointOfPlan2_X0Z(System.Drawing.Point Point_Source)
        {
            PointOfPlan2X0Z PointVar = new PointOfPlan2X0Z(-Point_Source.X, -Point_Source.Y);
            return PointVar;
        }
        ...
        /// <remarks>Для отрисовки точки начало системы координат определяется координатами X=0; Y=0 и расположено не в крайней или угловой точке изображения. 
        /// Не проверяет корректность координат возвращаемой проекции точки для формирования 3D точки</remarks>
        public GeometryObjects.PointOfPlan3Y0Z CnvPoint_ToPointOfPlan3_Y0Z(System.Drawing.Point Point_Source)
        {
            GeometryObjects.PointOfPlan3Y0Z PointVar = new GeometryObjects.PointOfPlan3Y0Z(Point_Source.X, -Point_Source.Y);
            return PointVar;
        }
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public Point2D CnvPoint_ToPoint2D(System.Drawing.Point Point_Source)
        {
            //Преобразует точку формата BaseGeometryYVP.GeomObjects.Point2D в System.Drawing.Point
            Point2D PtVar = new Point2D();
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public Point2D CnvPointF_ToPoint2D(System.Drawing.PointF PointF_Source)
        {
            //Преобразует точку формата BaseGeometryYVP.GeomObjects.Point2D в System.Drawing.PointF
            Point2D PtVar = new Point2D();
        ...
        public object TypeOf_ProectionByPoint(System.Drawing.Point PointProection_Source, System.Drawing.Point Frame2D_Centre)
        {
            ...
            GeometryObjects.PointOfPlan1X0Y PointOfPlan1_X0Y_FunVar = new GeometryObjects.PointOfPlan1X0Y();
            //Экземпляр горизонтальной проекции 3D точки для отрисовки в Graphics
            PointOfPlan2X0Z PointOfPlan2_X0Z_FunVar = new PointOfPlan2X0Z();
            //Экземпляр горизонтальной проекции 3D точки для отрисовки в Graphics
            GeometryObjects.PointOfPlan3Y0Z PointOfPlan3_Y0Z_FunVar = new GeometryObjects.PointOfPlan3Y0Z();
            //Экземпляр горизонтальной проекции 3D точки для отрисовки в Graphics
        ...
        public void DrawPointProection(GeometryObjects.PointOfPlan1X0Y PointXoY_Sourse, int PointRadius, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            System.Drawing.Point PointProjection_Temp = new System.Drawing.Point();
            PointProjection_Temp = PointPositionCorrection(CnvPoint3DProjection_ToPoint(PointXoY_Sourse), PointRadius, Frame2D_Centre);
        ...
        /// <param name="Graphics_Source">Поверхность для отрисовки</param>
        /// <remarks>Положение центра точки корректируется в зависимости от центра системы координат Монжа и заданного радиуса точки</remarks>
        public void DrawPointProection(PointOfPlan2X0Z PointXoY_Sourse, int PointRadius, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            System.Drawing.Point PointProjection_Temp = new System.Drawing.Point();
            PointProjection_Temp = PointPositionCorrection(CnvPoint3DProjection_ToPoint(PointXoY_Sourse), PointRadius, Frame2D_Centre);
        ...
        /// <param name="Graphics_Source">Поверхность для отрисовки</param>
        /// <remarks>Положение центра точки корректируется в зависимости от центра системы координат Монжа и заданного радиуса точки</remarks>
        public void DrawPointProection(GeometryObjects.PointOfPlan3Y0Z PointXoY_Sourse, int PointRadius, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            System.Drawing.Point PointProjection_Temp = new System.Drawing.Point();
            PointProjection_Temp = PointPositionCorrection(CnvPoint3DProjection_ToPoint(PointXoY_Sourse), PointRadius, Frame2D_Centre);
        ...
        public void DrawLinkLine(PointOfPlan1X0Y PointXoY_Sourse, bool LinkPointToX, bool LinkPointToY, bool LinkXToBorderPi2, bool LinkYToBorderPi3, bool LinkCurveY1ToY3, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            ...
            {//Горизонтальная (от Pi1 к Pi3) - Часть 1: отрезок от заданной точки до оси X
                Graphics_Source.DrawLine(Pen_LinkLineXoY_toX, Convert.ToInt32(Frame2D_Centre.X - PointXoY_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y + PointXoY_Sourse.Y), Convert.ToInt32(Frame2D_Centre.X - PointXoY_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y));
            }
            ...
            {//Горизонтальная (от Pi1 к Pi3) - Часть 2: отрезок от оси X до верхней границы области рисования (верхней границы плоскости проекций Pi2)
                Graphics_Source.DrawLine(Pen_LinkLineXoY_toX, Convert.ToInt32(Frame2D_Centre.X - PointXoY_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y), Convert.ToInt32(Frame2D_Centre.X - PointXoY_Sourse.X), -Convert.ToInt32(2 * Frame2D_Centre.Y + 20));
            }
            ...
            { //Горизонтальная (от Pi1 к Pi3) - Часть 3: отрезок от заданной точки до вертикальной оси Y (оси Y плоскости проекций Pi1)
                Graphics_Source.DrawLine(Pen_LinkLineXoY_toY, Convert.ToInt32(Frame2D_Centre.X - PointXoY_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y + PointXoY_Sourse.Y), Convert.ToInt32(Frame2D_Centre.X), Convert.ToInt32(Frame2D_Centre.Y + PointXoY_Sourse.Y));
            }
            ...
            {//Горизонтальная (от Pi1 к Pi3) - Часть 4: дуга от вертикальной оси Y до горизонтальной оси Y
                ...
                Graphics_Source.DrawArc(Pen_LinkLineXoY_toY, Convert.ToInt32(Frame2D_Centre.X) - Convert.ToInt32(PointXoY_Sourse.Y), Convert.ToInt32(Frame2D_Centre.Y) - Convert.ToInt32(PointXoY_Sourse.Y), Convert.ToInt32(2 * PointXoY_Sourse.Y), Convert.ToInt32(2 * PointXoY_Sourse.Y), 0, 90);
            }
            ...
            {//Вертикальная (от Pi1 к Pi2) - Часть 5: отрезок от горизонтальной оси Y до границы области рисования (верхней границы плоскости проекций Pi3)
                Graphics_Source.DrawLine(Pen_LinkLineXoY_toY, Convert.ToInt32(Frame2D_Centre.X + PointXoY_Sourse.Y), Frame2D_Centre.Y, Convert.ToInt32(Frame2D_Centre.X + PointXoY_Sourse.Y), 0);
            }
        }
        ...
        public void DrawLinkLine(PointOfPlan2X0Z PointXoZ_Sourse, bool LinkPointToX, bool LinkPointToZ, bool LinkXToBorderPi1, bool LinkZToBorderPi3, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            ...
            {//Вертикальная (от Pi2 к Pi1) - Часть 1: от точки до оси X
                Graphics_Source.DrawLine(Pen_LinkLineXoZ_toX, Convert.ToInt32(Frame2D_Centre.X - PointXoZ_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y - PointXoZ_Sourse.Z), Convert.ToInt32(Frame2D_Centre.X - PointXoZ_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y));
            }
            ...
            {//Вертикальная (от Pi2 к Pi1) - Часть 2: от оси X до границы Pi1
                Graphics_Source.DrawLine(Pen_LinkLineXoZ_toX, Convert.ToInt32(Frame2D_Centre.X - PointXoZ_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y), Convert.ToInt32(Frame2D_Centre.X - PointXoZ_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y - PointXoZ_Sourse.Z) + Convert.ToInt32(Frame2D_Centre.Y * 2 + 20));
            }
            ...
            {//Горизонтальная (от Pi2 к Pi3) - Часть 3: от точки до оси Z
                Graphics_Source.DrawLine(Pen_LinkLineXoZ_toZ, Convert.ToInt32(Frame2D_Centre.X - PointXoZ_Sourse.X), Convert.ToInt32(Frame2D_Centre.Y - PointXoZ_Sourse.Z), Convert.ToInt32(Frame2D_Centre.X), Convert.ToInt32(Frame2D_Centre.Y - PointXoZ_Sourse.Z));
            }
            ...
            {//Горизонтальная (от Pi2 к Pi3) - Часть 4: от оси Z до границы Pi3
                Graphics_Source.DrawLine(Pen_LinkLineXoZ_toZ, Convert.ToInt32(Frame2D_Centre.X), Convert.ToInt32(Frame2D_Centre.Y - PointXoZ_Sourse.Z), Convert.ToInt32(Frame2D_Centre.X - PointXoZ_Sourse.X) + Convert.ToInt32(Frame2D_Centre.X * 2 + 20), Convert.ToInt32(Frame2D_Centre.Y - PointXoZ_Sourse.Z));
            }
        }
        ...
        public void DrawLinkLine(PointOfPlan3Y0Z PointYoZ_Sourse, bool LinkPointToY, bool LinkPointToZ, bool LinkYToBorderPi1, bool LinkZToBorderPi2, bool LinkCurveY3ToY1, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            ...
            {//Горизонтальная (от Pi3 к Pi2) - часть 1: отрезок от заданной точки до оси Z на Pi2
                Graphics_Source.DrawLine(Pen_LinkLineYoZ_toZ, Convert.ToInt32(Frame2D_Centre.X + PointYoZ_Sourse.Y), Convert.ToInt32(Frame2D_Centre.Y - PointYoZ_Sourse.Z), Convert.ToInt32(Frame2D_Centre.X), Convert.ToInt32(Frame2D_Centre.Y - PointYoZ_Sourse.Z));
            }
            if (LinkPointToY == true)//Контроль включения линии связи от проекции точки до оси Y
            {
                Graphics_Source.DrawLine(Pen_LinkLineYoZ_toY, Convert.ToInt32(Frame2D_Centre.X + PointYoZ_Sourse.Y), Convert.ToInt32(Frame2D_Centre.Y - PointYoZ_Sourse.Z), Convert.ToInt32(Frame2D_Centre.X + PointYoZ_Sourse.Y), Convert.ToInt32(Frame2D_Centre.Y));
            ...
            {    //Часть 3: дуга (от Pi3 к Pi1)  от точки пересечения с горизонтальной осью Y до вертикальной оси Y
                ...
                Graphics_Source.DrawArc(Pen_LinkLineYoZ_toY, Convert.ToInt32(Frame2D_Centre.X) - Convert.ToInt32(PointYoZ_Sourse.Y), Convert.ToInt32(Frame2D_Centre.Y) - Convert.ToInt32(PointYoZ_Sourse.Y), Convert.ToInt32(2 * PointYoZ_Sourse.Y), Convert.ToInt32(2 * PointYoZ_Sourse.Y), 0, 90);
            }
            ...
            { //Горизонтальная (от Pi3 к Pi2) - часть 4: отрезок от вертикальной оси Y на Pi1 до границы области рисования
                Graphics_Source.DrawLine(Pen_LinkLineYoZ_toY, Convert.ToInt32(Frame2D_Centre.X), Convert.ToInt32(Frame2D_Centre.Y + PointYoZ_Sourse.Y), 0, Convert.ToInt32(Frame2D_Centre.Y + PointYoZ_Sourse.Y));
            }
            ...
            {//Горизонтальная (от Pi3 к Pi2) - часть 4: отрезок от заданной точки до оси Z на Pi2
                Graphics_Source.DrawLine(Pen_LinkLineYoZ_toZ, Convert.ToInt32(Frame2D_Centre.X), Convert.ToInt32(Frame2D_Centre.Y - PointYoZ_Sourse.Z), 0, Convert.ToInt32(Frame2D_Centre.Y - PointYoZ_Sourse.Z));
            }
        }
        ...
        public void DrawLinkLine(PointOfPlan1X0Y PointXoY_Sourse, PointOfPlan2X0Z PointXoZ_Sourse, PointOfPlan3Y0Z PointYoZ_Sourse, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            ...
            {
                DrawLinkLine(PointYoZ_Sourse, true, true, true, true, true, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Профильной проекции без ограничений
                return;
            }
            else if (PointXoY_Sourse == null & PointYoZ_Sourse == null) //Горизонтальная и профильная проекции не существуют
            {
                DrawLinkLine(PointXoZ_Sourse, true, true, true, true, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Фронтальной проекции без ограничений
                return;
            }
            else if (PointXoZ_Sourse == null & PointYoZ_Sourse == null)//Фронтальная и профильная проекции не существуют
            {
                DrawLinkLine(PointXoY_Sourse, true, true, true, true, true, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Горизонтальной проекции без ограничений
                return;
            }
            //3. Контроль существования одной проекции точки
            else if (PointXoY_Sourse == null) //Горизонтальная проекция не существует
            {
                DrawLinkLine(PointXoZ_Sourse, true, true, true, false, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Фронтальной проекции с ограничениями (не отображается связь от Z до правой границы Pi3)
                DrawLinkLine(PointYoZ_Sourse, true, true, true, false, true, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Профильной проекции с ограничениями (не отображается связь от Z до левой границы Pi2)
                return;
            }
            else if (PointXoZ_Sourse == null)//Фронтальная проекция не существует
            {
                DrawLinkLine(PointXoY_Sourse, true, true, true, false, true, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Горизонтальной проекции без ограничений (не отображается связь от Y до верхней границы Pi3)
                DrawLinkLine(PointYoZ_Sourse, true, true, false, true, false, Frame2D_Centre, ref Graphics_Source);  //Отрисовка линий связи Профильной проекции с ограничениями (не отображается связь от Y до левой границы Pi1 и дуга (для дуги устраняется повторная отрисовка))
                return;
            }
            else if (PointYoZ_Sourse == null) //Профильная проекция не существует
            {
                DrawLinkLine(PointXoY_Sourse, true, true, false, true, true, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Горизонтальной проекции без ограничений (не отображается связь от X до верхней границы Pi2)
                DrawLinkLine(PointXoZ_Sourse, true, true, false, true, Frame2D_Centre, ref Graphics_Source); //Отрисовка линий связи Фронтальной проекции с ограничениями (не отображается связь от X до нижней границы Pi1)
                return;
            }
            else
            {
            ...
            {
                DrawLinkLine(PointXoY_Sourse, true, true, false, false, true, Frame2D_Centre, ref Graphics_Source); //Отрисовка линий связи Горизонтальной проекции без ограничений (не отображаются связи от осей до границ плоскотсей проекций)
                DrawLinkLine(PointXoZ_Sourse, true, true, false, false, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Фронтальной проекции с ограничениями (не отображаются связи от осей до границ плоскотсей проекций)
                DrawLinkLine(PointYoZ_Sourse, true, true, false, false, false, Frame2D_Centre, ref Graphics_Source);//Отрисовка линий связи Профильной проекции с ограничениями (не отображаются связи от осей до границ плоскотсей проекций и дуга (для дуги устраняется повторная отрисовка))
            }
        }
        ...
        public void DrawLinkLine(Point3D Point3D_Sourse, Point Frame2D_Centre, ref Graphics Graphics_Source)
        {
            ...
            DrawLinkLine(Point3D_Sourse.PointOfPlan1X0Y, Point3D_Sourse.PointOfPlan2X0Z, Point3D_Sourse.PointOfPlan3Y0Z, Frame2D_Centre, ref Graphics_Source);
        }
    }
}