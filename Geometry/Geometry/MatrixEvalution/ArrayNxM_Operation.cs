...
namespace GeometryObjects
{
    ...
    public class ArrayNxM_Operation : ArrayNxM_Double
    {


        private ArrayControl ArrayControlVar = new ArrayControl();
        public ArrayNxM_Operation()
        {
        }
        ...
        /// <remarks> </remarks>
        public object[,] MoveUnit(object[,] ArrayNxM_Source, int NumRow, int NumCol)
        {
            ...
            //Переменные циклов
            int a = 0;
            object[,] MrxTrans = null;
            object[,] MrxTransInt = null;
            //Вспомогательные матрицы
            MrxTrans = new object[ArrayNxM_Source.GetUpperBound(0) + 1, ArrayNxM_Source.GetUpperBound(1) + 1];
            //Установка размерности MrxTrans(,)
            MrxTransInt = new object[MrxTrans.GetUpperBound(0) + 1, MrxTrans.GetUpperBound(1) + 1];
            //Установка размерности MrxTransInt(,)
            MrxTrans = (object[,])ArrayNxM_Source.Clone();
            MrxTransInt = (object[,])MrxTrans.Clone();
        Calc_Step2:
            ...
            VarMrxZero = ArrayNxM_Zero(MrxTrans);
            //Матрица пустая
            if (VarMrxZero == true)
            {
        ...
        Calc_Step3:
            ...
            MrxTransInt = MoveToDown_ZeroRows(MrxTrans);
            //Перестановка нулевых столбцов
            MrxTransInt = MoveToRight_ZeroCols(MrxTransInt);
            MrxTrans = (object[,])MrxTransInt.Clone();
        Calc_Step3a:
        ...
        Calc_Step4б:
            ...
            while (j <= MrxTrans.GetUpperBound(1))
            {
                ...
                if (ZeroCol(MrxTrans, j) == true)
                {
                    goto RowZero_i;
                }
                else
                {
                    if (MrxTrans.GetValue(i, j) == (object)0 | MrxTrans.GetValue(i, j) == MrxTrans.GetValue(NumRow, NumCol))
                    {
                        goto CollZero_j;
                    }
                    else
                    {
                        MrxTransInt = ReplaceCols(MrxTrans, j, NumCol);
                        //Замена элементов по строке
                        MrxTransInt = ReplaceRows(MrxTransInt, i, NumCol);
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source" >Заданный массив</param>
        public object[,] MoveToDown_ZeroRows(object[,] ArrayNxM_Source)
        {
            bool? VarMrxZero = false;
            //Переменная для определения пустой матрицы
        ...
        Calc_Step3:
            ...
            {
                VarRowZero = ZeroRow(MrxTrans, i1);
                //Строка содержит не нулевые элементы 
                if (VarRowZero == false)
                {
                    MrxTransInt = ReplaceRows(MrxTrans, i1, i);
                    //Перестановка строк
                    goto RowI;
                }
                i1 += 1;
        ...
        /// </summary> 
        /// <param name="ArrayNxM_Source" >Заданный массив</param>
        public object[,] MoveToRight_ZeroCols(object[,] ArrayNxM_Source)
        {
            object[,] MrxTrans = null;
            object[,] MrxTransInt = null;
            //Вспомогательные матрицы
        ...
        Calc_Step3:
            ...
            {
                VarСolZero = ZeroCol(MrxTrans, j1);
                //Столбец содержит не нулевые элементы 
                if (VarСolZero == false)
                {
                    MrxTransInt = ReplaceCols(MrxTrans, j1, j);
        ...
        public int[] IndexList_ZeroRows(object[,] ArrayNxM_Source)
        {
            int i = 0;
            int j = 0;
            ...
            while (i <= ArrayNxM_Source.GetUpperBound(0))
            {
                ...
                {
                    if (ArrayNxM_Source.GetValue(i, j) == (object)0)
                    {
                        VarRow = true;
                    }
                    else
        ...
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        /// <remarks>Возвращает в списке -1, если нулевые строки в массиве отсутсвуют</remarks>
        public int[] IndexList_ZeroCols(object[,] ArrayNxM_Source)
        {
            int i = 0;
            int j = 0;
        ...
        public bool? ZeroRow(object[,] ArrayNxM_Source, int NumRow)
        {
            int j = 0;
            ...
            while (j <= ArrayNxM_Source.GetUpperBound(1))
            {
                if (ArrayNxM_Source.GetValue(NumRow, j) == (object)0)
                {
                    VarRow = true;
                }
                else
        ...
        public bool? ZeroCol(object[,] ArrayNxM_Source, int NumCol)
        {
            int i = 0;
            ...
            while (i <= ArrayNxM_Source.GetUpperBound(0))
            {
                if (ArrayNxM_Source.GetValue(i, NumCol) == (object)0)
                {
                    VarColl = true;
                }
                else
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public object[,] ReplaceRows(object[,] ArrayNxM_Source, int NumRow1, int NumRow2)
        {
            int j = 0;
            ...
            if (Row1IsRow2(ArrayNxM_Source, NumRow1, NumRow2) == true)
            {
                return MrxTrans;
            }
            else
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public object[,] ReplaceCols(object[,] ArrayNxM_Source, int NumCol_1, int NumCol_2)
        {
            int i = 0;
            //Переменная номера строки
            object[,] MrxTrans = null;
            ...
            MrxTrans = (object[,])ArrayNxM_Source.Clone();
            //Проверка равентсва заданных строк
            if (Col1IsCol2(ArrayNxM_Source, NumCol_1, NumCol_2) == true)
            {
                return MrxTrans;
            }
            else
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public bool ArrayNxM_Zero(object[,] ArrayNxM_Source)
        {
            int i = 0;
            int j = 0;
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public bool Row1IsRow2(object[,] ArrayNxM_Source, int NumRow1, int NumRow2)
        {
            int j = 0;
            //Переменная номеров столбцов
            bool VarRow = false;
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public bool Col1IsCol2(object[,] ArrayNxM_Source, int NumCol1, int NumCol2)
        {
            int i = 0;
            //Переменная номеров строк
            bool VarColl = false;
        ...
        public ArrayList Cut_ColAsList(int NumСol, int RowStart, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(RowStart, NumСol, SourceArray) == false)
            {
                return null;
            }
        ...
        public ArrayList Cut_ColAsList(int NumСol, int RowStart, int RowEnd, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_ColAndIndexRow(RowStart, RowEnd, NumСol, SourceArray) == false)
            {
                return null;
            }
            ArrayList NameGrp = new ArrayList();
        ...
        public ArrayList Cut_RowAsList(int NumRow, int ColStart, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(NumRow, ColStart, SourceArray) == false)
            {
                return null;
            }
            ArrayList NameGrp = new ArrayList();
        ...
        public ArrayList Cut_RowAsList(int NumRow, int ColStart, int ColEnd, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_RowAndIndexCol(NumRow, ColStart, ColEnd, SourceArray) == false)
            {
                return null;
            }
            ArrayList NameGrp = new ArrayList();
        ...
        /// <param name="RowStart">Номер строки, задающей начало записи данных</param>
        public object[] Cut_Col(int NumCol, int RowStart, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(RowStart, NumCol, SourceArray) == false)
            {
                return null;
            }
            object[] ColArray = null;
            int j = 0;
            for (int i = RowStart; i <= SourceArray.GetUpperBound(0); i++)
            {
        ...
        /// <param name="NumCol">Номер столбца</param>
        /// <param name="RowStart">Номер строки, задающей начало записи данных</param>
        public object[] Cut_Col(int NumCol, int RowStart, int RowEnd, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_ColAndIndexRow(RowStart, RowEnd, NumCol, SourceArray) == false)
            {
                return null;
            }
            object[] ColArray = null;
        ...
        /// <param name="NumRow">Номер строки</param>
        /// <param name="ColStart">Номер столбца, задающего начало записи данных</param>
        public object[] Cut_Row(int NumRow, int ColStart, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(NumRow, ColStart, SourceArray) == false)
            {
        ...
        public object[,] Cut_PartArray(int RowStart, int ColStart, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(RowStart, ColStart, SourceArray) == false)
            {
                return null;
            }
            ...
            {
                object[,] ArrayOut = new object[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 1];
        ...
        public object[,] Cut_PartArray(int RowStart, int RowEnd, int ColStart, int ColEnd, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(RowStart, RowEnd, ColStart, ColEnd, SourceArray) == false)
            {
                return null;
            }
            object[,] PartArray = new object[RowEnd + 1, ColEnd + 1];
            for (int i = RowStart; i <= RowEnd; i++)
            {
                for (int j = ColStart; j <= ColEnd; j++)
                {
        ...
        public object[,] ClearArrayAroundPart(int RowStart, int RowEnd, int ColStart, int ColEnd, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(RowStart, RowEnd, ColStart, ColEnd, SourceArray) == false)
            {
        ...
        public object[,] PartArrayToArrayCopy(int RowStart, int RowEnd, int ColStart, int ColEnd, object[,] SourceArray, object[,] DestinationArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(RowStart, RowEnd, ColStart, ColEnd, SourceArray) == false)
            {
            ...
            else
            {
                ...
                {
                    DestArrayVar = (object[,])DestinationArray.Clone();
                    //Копия выходного массива
                    DestinationArray = new object[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 1];
                }
                else if (SourceArray.GetUpperBound(0) > DestinationArray.GetUpperBound(0) & SourceArray.GetUpperBound(1) <= DestinationArray.GetUpperBound(1))
                {
                    DestArrayVar = (object[,])DestinationArray.Clone();
                    //Копия выходного массива
                    DestinationArray = new object[SourceArray.GetUpperBound(0) + 1, DestArrayVar.GetUpperBound(1) + 1];
                }
                else if (SourceArray.GetUpperBound(0) <= DestinationArray.GetUpperBound(0) & SourceArray.GetUpperBound(1) > DestinationArray.GetUpperBound(1))
                {
                    DestArrayVar = (object[,])DestinationArray.Clone();
                    //Копия выходного массива
                    DestinationArray = new object[DestArrayVar.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 1];
                }
                else
                {
                    goto DataCopy;
        ...
        /// <param name="ColStart">Номер начального столбца копируемой области</param>
        /// <remarks>Вставляет содержимое в интервал, определяемый заданными номерами строк и столбцов</remarks>
        public object[,] PartArrayToArrayCopy(int RowStart, int ColStart, object[,] SourceArray, object[,] DestinationArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(RowStart, ColStart, SourceArray) == false)
            {
        ...
        public object[,] CnvArrayListToArray2D(ArrayList SourceArrayList)
        {
            //Возвращает двумерный массив, содержащий в первой колонке номера ячеек ArrayList, во второй - значения ячеек ArrayList
            object[,] Array2D_Out = new object[SourceArrayList.Count, 2];
        ...
        /// <remarks>Вставляет содержимое в интервал, определяемый заданными номерами строк и столбцов</remarks>
        public bool? Control_RowValue(object Value, int NumRow, int ColStart, object[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControlVar.Control_IndexRowAndCol(NumRow, ColStart, SourceArray) == false)
            {
        ...
        /// <param name="ColStart">Номер столбца, задающего начало контролируемой области</param>
        /// <remarks>Вставляет содержимое в интервал, определяемый заданными номерами строк и столбцов</remarks>
        public int[] IndexRowsOfNonValue(object Value, int NumRow, int ColStart, object[,] SourceArray)
        {
            //Возвращает номера строк двумерного массива, в которых нет заданного значения, начиная с заданной строки и заданного столбца
            ...
            {
                if (Control_RowValue(Value, i, ColStart, SourceArray) == false)
                {
        ...
        //==============================================================================================================================================================
        //------------------------------------------------- Вставка и замена столбцов в заданный массив (As Object) ----------------------------------------------------
        ...
        /// <returns>Возвращает двумерный массив As Object</returns>
        /// <remarks>
        ...
        /// </remarks>
        public object[,] Array_CollAdd(int IndexAddColl, object[,] SourceArray)
        {
            object[,] ArrayVar = new object[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 2];
        ...
        /// </remarks>
        public object[,] Array_CollAdd(int CountColls, object[,] SourceArray, int IndexForAddFirstColl)
        {
            object[,] ArrayVar = new object[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + CountColls + 1];
        ...
        /// </remarks>
        public object[,] Array_CollAdd(object[] AddArray, object[,] SourceArrayForAdd, int IndexForCollAdd)
        {
            object[,] ArrayVar = new object[SourceArrayForAdd.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + 2];
            //Выходной массив, размерностью больше на один столбец заданного массива
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданного столбца
            ...
            {
                ArrayVar = new object[AddArray.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + 2];
            }
            //Вставка нового столбца, имеющего индекс, равный нулю
        ...
        /// </remarks>
        public object[,] Array_CollAdd(object[,] AddArray, object[,] SourceArrayForAdd, int IndexForAddFirstColl)
        {
            object[,] ArrayVar = null;
            //Выходной массив
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданного столбца
            ...
            {
                ArrayVar = new object[AddArray.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + AddArray.GetUpperBound(1) + 2];
            }
            else
            {
                ArrayVar = new object[SourceArrayForAdd.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + AddArray.GetUpperBound(1) + 2];
        ...
        /// </remarks>
        public object[,] Array_CollСhange(object[] СhangeArray, object[,] SourceArrayForСhange, int IndexOfChangeColl)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданного столбца
        ...
        /// При значении добавляемого массива, равном "Nothing" возвращается исходный массив.
        /// </remarks>
        public object[,] Array_CollСhange(object[,] СhangeArray, object[,] SourceArrayForСhange, int IndexFirstChangeColl)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданного столбца
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------------------
        //==============================================================================================================================================================
        //------------------------------------------------- Вставка и замена строк в заданный массив (As Object) -------------------------------------------------------
        ...
        /// </remarks>
        public object[,] Array_RowAdd(int IndexAddRow, object[,] SourceArray)
        {
            object[,] ArrayVar = new object[SourceArray.GetUpperBound(0) + 2, SourceArray.GetUpperBound(1) + 1];
        ...
        /// </remarks>
        public object[,] Array_RowAdd(int CountRows, object[,] SourceArray, int IndexForAddFirstRow)
        {
            object[,] ArrayVar = new object[SourceArray.GetUpperBound(0) + CountRows + 1, SourceArray.GetUpperBound(1) + 1];
        ...
        /// </remarks>
        public object[,] Array_RowAdd(object[] AddArray, object[,] SourceArrayForAdd, int IndexForRowAdd)
        {
            object[,] ArrayVar = new object[SourceArrayForAdd.GetUpperBound(0) + 2, SourceArrayForAdd.GetUpperBound(1) + 1];
            //Выходной массив, размерностью больше на одну строку заданного массива
            int i = 0;
            int j = 0;
            ...
            {
                ArrayVar = new object[SourceArrayForAdd.GetUpperBound(0) + 2, AddArray.GetUpperBound(0) + 1];
            }
            //Вставка новой строки, имеющей индекс, равный нулю
            if (IndexForRowAdd == 0)
            {
        ...
        /// При значении добавляемого массива, равном "Nothing" возвращается исходный массив.
        /// </remarks>
        public object[,] Array_RowAdd(object[,] AddArray, object[,] SourceArrayForAdd, int IndexForAddFirstRow)
        {
            object[,] ArrayVar = null;
            //Выходной массив
            int i = 0;
            ...
            {
                ArrayVar = new object[SourceArrayForAdd.GetUpperBound(0) + AddArray.GetUpperBound(0) + 2, AddArray.GetUpperBound(1) + 1];
            }
            else
            {
                ArrayVar = new object[SourceArrayForAdd.GetUpperBound(0) + AddArray.GetUpperBound(0) + 2, SourceArrayForAdd.GetUpperBound(1) + 1];
        ...
        /// </remarks>
        public object[,] Array_RowСhange(object[] СhangeArray, object[,] SourceArrayForAdd, int IndexOfChangeRow)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданной строки
        ...
        /// При значении добавляемого массива, равном "Nothing" возвращается исходный массив.
        /// </remarks>
        public object[,] Array_RowСhange(object[,] СhangeArray, object[,] SourceArrayForAdd, int IndexFirstChangeRow)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданной строки
