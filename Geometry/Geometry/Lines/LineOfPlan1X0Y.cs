namespace GeometryObjects
{
    ...
    public class LineOfPlan1X0Y
    {
        ...
        private GeometryObjects.PointOfPlan1X0Y Point_0_Cls = new GeometryObjects.PointOfPlan1X0Y();
        //Вторая точка прямой
        private GeometryObjects.PointOfPlan1X0Y Point_1_Cls = new GeometryObjects.PointOfPlan1X0Y();
        ...
        /// <remarks></remarks>
        public LineOfPlan1X0Y(Point3D Point_0, Point3D Point_1)
        {
        ...
        /// <summary>Инициализирует новый экземпляр двумерной проекции прямой по заданным проекциям базовой и второй точек</summary>
        /// <remarks></remarks>
        public LineOfPlan1X0Y(GeometryObjects.PointOfPlan1X0Y Point_0, GeometryObjects.PointOfPlan1X0Y Point_1)
        {
        ...
        /// <remarks></remarks>
        public GeometryObjects.PointOfPlan1X0Y Point_0
        {
        ...
        /// <remarks></remarks>
        public GeometryObjects.PointOfPlan1X0Y Point_1
        {
            // Считывание значения X
