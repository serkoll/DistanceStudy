...
namespace GeometryObjects
{
    ...
    public class Line2D
    {
        ...
        private Point2D Point_0_Cls = new Point2D();
        //Вторая (расчетная или заданная) точка прямой
        private Point2D Point_1_Cls = new Point2D();
        ...
        public double SolveError
        {
            ...
            get { return SolveErrorLine_Cls; }
            // Установка значения точности расчета
            set { SolveErrorLine_Cls = value; }
        }
        ...
        public Point2D GetPoint1(double t)
        {
            ...
            return (new Point2D(Point_0.X + kx * t, Point_0.Y + ky * t));
        }
        ...
        /// Первая заданная точка записывается в качестве опорной точки прямой.
        /// </remarks>
        public void LineBy2Points(Point2D Point1, Point2D Point2)
        {
            //Конструктор рассчитывает значения постоянных коэффициентов 2D прямой, заданной двумя 2D точками 
            Line2D Line2DNew = new Line2D(Point1, Point2);
            Point_0 = Line2DNew.Point_0;
            //Начальная точка прямой
            Point_1 = Line2DNew.Point_1;
            //Вторая точка прямой
        ...
        /// <remarks></remarks>
        public void PerpendicularPointToLine(Line2D Line, Point2D Point)
        {
        ...
        /// <remarks></remarks>
        public void ParallelPointToLine(Line2D Line, Point2D Point)
        {
