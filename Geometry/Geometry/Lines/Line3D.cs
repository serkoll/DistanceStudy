...
namespace GeometryObjects
{
    ...
    public class Line3D : Line2D
    {
        ...
        private Point3D Point_0_Cls = new Point3D();

        private Point3D Point_1_Cls = new Point3D();
        ...
        /// <remarks></remarks>
        public double? GetLine_t(Point3D Point, Line3D Line)
        {
            ...
            else
            {
                ...
                EqSysCalculation EqVar = new EqSysCalculation();
        ...
        public LineOfPlan1X0Y LineOfPlan1_X0Y
        {
            ...
            // Считывание значений
            get { return new LineOfPlan1X0Y(Point_0, Point_1); }
        }
        ...
        /// <remarks></remarks>
        public LineOfPlan2X0Z LineOfPlan2_X0Z
        {
            // Свойство проекции 3D прямой на плоскость X0Z
            // Считывание значений
            get { return new LineOfPlan2X0Z(Point_0, Point_1); }
        }
        ...
        /// <remarks></remarks>
        public GeometryObjects.LineOfPlan3Y0Z LineOfPlan3_Y0Z
        {
            // Свойство проекции 3D прямой на плоскость Y0Z
            // Считывание значений
            get { return new GeometryObjects.LineOfPlan3Y0Z(Point_0, Point_1); }
        }
            ...
            : base()
        {
            ...
            Point_0.Z = 0;
            kz = 0;
            Point_1.X = kx + Point_0.X;
            Point_1.Y = ky + Point_0.Y;
            Point_1.Z = kz + Point_0.Z;
        }
        ...
        /// <remarks></remarks>
        public Line3D(Point3D BasePointLine, double Line_kx, double Line_ky, double Line_kz)
        {
            ...
            {
                Point_0.X = BasePointLine.X;
                Point_0.Y = BasePointLine.Y;
                Point_0.Z = BasePointLine.Z;
                kx = Line_kx;
                ky = Line_ky;
                kz = Line_kz;
                Point_1.X = kx + Point_0.X;
        ...
        public Line3D(Point3D Point1, Point3D Point2)
        {
            ...
            PointsPositionControl PointVar = new PointsPositionControl();
        ...
        public Line3D(GeometryObjects.PlaneSpace Plane1, GeometryObjects.PlaneSpace Plane2)
        {
            //Конструктор возвращает значения коэффициентов 3D прямой, заданной двумя плоскостями
            Line3D Line = new Line3D();
            GeometryObjects.PlaneSpace PlaneVar = new GeometryObjects.PlaneSpace();
        ...
        public Line3D CreateLine3DBy3Projections(LineOfPlan1X0Y linePi1, LineOfPlan2X0Z linePi2, LineOfPlan3Y0Z linePi3, ref ErrObject errorPoint3D, bool errorMsgBoxFlag)
        {//Функция задания 3D точки по 3-м проекциям без указания осей
            var Line3DByProectVar = new Line3D();
            if (linePi1 != null & linePi2 != null & linePi3 == null) { Line3DByProectVar = CreateLine3DBy2Projections12(linePi1, linePi2, ref errorPoint3D, errorMsgBoxFlag); }
            else if (linePi1 != null & linePi2 == null & linePi3 != null) { Line3DByProectVar = CreateLine3DBy2Projections13(linePi1, linePi3, ref errorPoint3D, errorMsgBoxFlag); }
            else if (linePi1 == null & linePi2 != null & linePi3 != null) { Line3DByProectVar = CreateLine3DBy2Projections23(linePi2, linePi3, ref errorPoint3D, errorMsgBoxFlag); }
            else if (linePi1 != null & linePi2 != null & linePi3 != null)
            {
                Line3DByProectVar = CreateLine3DBy2Projections12(linePi1, linePi2, ref errorPoint3D, errorMsgBoxFlag);
                if (Line3DByProectVar == null) { return null; }//Контроль для проекций 1, 2
                Line3DByProectVar = CreateLine3DBy2Projections13(linePi1, linePi3, ref errorPoint3D, errorMsgBoxFlag);
                if (Line3DByProectVar == null) { return null; }//Контроль для проекций 1, 3
                Line3DByProectVar = CreateLine3DBy2Projections23(linePi2, linePi3, ref errorPoint3D, errorMsgBoxFlag);
                if (Line3DByProectVar == null) { return null; }//Контроль для проекций 2, 3
            }
            else
            {
        ...
        /// <param name="pointPi2"> Фронтальная проекция 3D точки</param>
        /// <returns> BaseGeometryYVP.GeomObjects.Point3D </returns>
        public Line3D CreateLine3DBy2Projections12(LineOfPlan1X0Y linePi1, LineOfPlan2X0Z linePi2, ref ErrObject errorPoint3D, bool errorMsgBoxFlag)
        {//Функция задания 3D точки по 3-м проекциям без указания осей
            var line3DByProectVar = new Line3D();
            ...
            if (linePi1.Point_0.X == linePi2.Point_0.X &&
                linePi1.Point_1.X == linePi2.Point_1.X)
            {
                line3DByProectVar.Point_0.X = linePi1.Point_0.X;
                line3DByProectVar.Point_0.Y = linePi1.Point_0.Y;
                line3DByProectVar.Point_0.Z = linePi2.Point_0.Z;
                line3DByProectVar.Point_1.X = linePi1.Point_1.X;
                line3DByProectVar.Point_1.Y = linePi1.Point_1.Y;
                line3DByProectVar.Point_1.Z = linePi2.Point_1.Z;
                return line3DByProectVar;
            }
            else if (linePi1.Point_0.X == linePi2.Point_1.X &&
                linePi1.Point_1.X == linePi2.Point_0.X)
            {
                line3DByProectVar.Point_0.X = linePi1.Point_1.X;
                line3DByProectVar.Point_0.Y = linePi1.Point_1.Y;
                line3DByProectVar.Point_0.Z = linePi2.Point_0.Z;
                line3DByProectVar.Point_1.X = linePi1.Point_0.X;
                line3DByProectVar.Point_1.Y = linePi1.Point_0.Y;
                line3DByProectVar.Point_1.Z = linePi2.Point_1.Z;
                return line3DByProectVar;
            }
            else
        ...
        /// <returns> BaseGeometryYVP.GeomObjects.Point3D </returns>
        public Line3D CreateLine3DBy2Projections13(LineOfPlan1X0Y linePi1, LineOfPlan3Y0Z linePi3, ref ErrObject errorPoint3D, bool errorMsgBoxFlag)
        { //Функция задания 3D точки по 3-м проекциям без указания осей
            var line3DByProectVar = new Line3D();
            string PtProectionName, PtCoordName, CommentBefore, CommentAfter, CommentDownBefore, CommentDownAfter;
            CommentBefore = "Неверно заданы координаты"; CommentAfter = "проекций пространственной точки"; CommentDownBefore = "Значения координтат"; CommentDownAfter = "этих проекций должны быть равны";
            //Контроль второй и третьей проекции + Контроль первой и третьей проекции
            if (linePi1.Point_0.Y == linePi3.Point_0.Y &&
                linePi1.Point_1.Y == linePi3.Point_1.Y)
            {
                line3DByProectVar.Point_0.X = linePi1.Point_0.X;
                line3DByProectVar.Point_0.Y = linePi1.Point_0.Y;
                line3DByProectVar.Point_0.Z = linePi3.Point_0.Z;
                line3DByProectVar.Point_1.X = linePi1.Point_1.X;
                line3DByProectVar.Point_1.Y = linePi1.Point_1.Y;
                line3DByProectVar.Point_1.Z = linePi3.Point_1.Z;
                return line3DByProectVar;
            }
            else if(linePi1.Point_0.Y == linePi3.Point_1.Y &&
                    linePi1.Point_1.Y == linePi3.Point_0.Y)
            {
                line3DByProectVar.Point_0.X = linePi1.Point_0.X;
                line3DByProectVar.Point_0.Y = linePi1.Point_0.Y;
                line3DByProectVar.Point_0.Z = linePi3.Point_1.Z;
                line3DByProectVar.Point_1.X = linePi1.Point_1.X;
                line3DByProectVar.Point_1.Y = linePi1.Point_1.Y;
                line3DByProectVar.Point_1.Z = linePi3.Point_0.Z;
                return line3DByProectVar;
            }
            else
            {
        ...
        /// <param name="pointPi3"> Профильная проекция 3D точки</param>
        /// <returns> BaseGeometryYVP.GeomObjects.Point3D </returns>
        public Line3D CreateLine3DBy2Projections23(LineOfPlan2X0Z linePi2, LineOfPlan3Y0Z linePi3, ref ErrObject errorPoint3D, bool errorMsgBoxFlag)
        {//Функция задания 3D точки по 3-м проекциям без указания осей
            var line3DByProectVar = new Line3D();
            string PtProectionName, PtCoordName, CommentBefore, CommentAfter, CommentDownBefore, CommentDownAfter;
            CommentBefore = "Неверно заданы координаты"; CommentAfter = "проекций пространственной точки"; CommentDownBefore = "Значения координтат"; CommentDownAfter = "этих проекций должны быть равны";
            //Контроль второй и третьей проекции
            if (linePi2.Point_0.Z == linePi3.Point_0.Z &&
                linePi2.Point_1.Z == linePi3.Point_1.Z)
            {
                line3DByProectVar.Point_0.X = linePi2.Point_0.X;
                line3DByProectVar.Point_0.Y = linePi3.Point_0.Y;
                line3DByProectVar.Point_0.Z = linePi2.Point_0.Z;
                line3DByProectVar.Point_1.X = linePi2.Point_1.X;
                line3DByProectVar.Point_1.Y = linePi3.Point_1.Y;
                line3DByProectVar.Point_1.Z = linePi2.Point_1.Z; 
                return line3DByProectVar;
            }
            else if (linePi2.Point_1.Z == linePi3.Point_0.Z &&
                    linePi2.Point_0.Z == linePi3.Point_1.Z)
            {
                line3DByProectVar.Point_0.X = linePi2.Point_0.X;
                line3DByProectVar.Point_0.Y = linePi3.Point_1.Y;
                line3DByProectVar.Point_0.Z = linePi2.Point_0.Z;
                line3DByProectVar.Point_1.X = linePi2.Point_1.X;
                line3DByProectVar.Point_1.Y = linePi3.Point_0.Y;
                line3DByProectVar.Point_1.Z = linePi2.Point_1.Z;
                return line3DByProectVar;
            }
            else
        ...
        /// Первая заданная точка записывается в качестве опорной точки прямой.
        /// </remarks>
        public void LineBy2Points(Point3D Point1, Point3D Point2)
        {
            //Конструктор рассчитывает значения постоянных коэффициентов 3D прямой, заданной двумя 3D точками 
        ...
        public void LineByTwoPlans(GeometryObjects.PlaneSpace Plane1, GeometryObjects.PlaneSpace Plane2)
        {
            //Конструктор возвращает значения коэффициентов 3D прямой, заданной двумя плоскостями
        ...
        /// <remarks></remarks>
        public void ParallelPointToLine(Line3D Line, Point3D Point)
        {
        ...
        /// <remarks></remarks>
        public void PerpendicularPointToTwoLines(Line3D Line1, Line3D Line2, Point3D Point)
        {
            ...
            if (LinePositionControl.LinesIsLines(Line1, Line2) == true)
            {
                ...
                PerpendicularPointToLine(Line1, Point);
        ...
        /// </remarks>
        public double[,] LineGeneralEquations(GeometryObjects.PlaneSpace Plane1, GeometryObjects.PlaneSpace Plane2)
        {
            //Конструктор возвращает значения коэффициентов 3D прямой, заданной двумя плоскостями
        ...
        /// <param name="Line">Заданная 3D прямая</param>
        /// <remarks></remarks>
        public void PerpendicularPointToLine(Point3D Point, Line3D Line)
        {
        ...
        public Point3D DirectingVector3DLine(Line3D Line)
        {
            ...
            return new Point3D(CosAl, CosBt, CosGm);
        }
        ...
        public Line3D ProectionLineOnPlane(Line3D Line, GeometryObjects.PlaneSpace Plane)
        {
            Line3D functionReturnValue = default(Line3D);
            //Функция возвращает прямую, как проекцию прямой на заданную плоскость
            Line3D ProectionLine = new Line3D();
            dynamic PlaneLine = default(GeometryObjects.PlaneSpace);
            dynamic NormVectPlane = default(GeometryObjects.PlaneSpace);
            GeometryObjects.PlaneSpace PlaneVar = new GeometryObjects.PlaneSpace();
        ...
        {
            GeometryObjects.LineOfPlan2X0Z LineVar = new GeometryObjects.LineOfPlan2X0Z(Line3D_Source);
            return LineVar;
        }
        ...
        {
            GeometryObjects.LineOfPlan3Y0Z LineVar = new GeometryObjects.LineOfPlan3Y0Z(Line3D_Source);
            return LineVar;
        }
        ...
        {
            GeometryObjects.LineOfPlan1X0Y LineVar = new GeometryObjects.LineOfPlan1X0Y();
        ...
        {
            GeometryObjects.LineOfPlan2X0Z LineVar = new GeometryObjects.LineOfPlan2X0Z();
            return LineVar.CnvLine2D(Point_Source);
        }
        ...
        {
            GeometryObjects.LineOfPlan3Y0Z LineVar = new GeometryObjects.LineOfPlan3Y0Z();
            return LineVar.CnvLine2D(Point_Source);
        }
