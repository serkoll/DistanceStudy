...
namespace GeometryObjects
{
    ...
    public static class LinesCalculator
    {
        ...
        public static double? DistantionLineToLine(Line3D Line1, Line3D Line2)
        {
            ...
            Point3D Point1Line3_0 = new Point3D();
            Point3D Point2Line3_0 = new Point3D();
            Point3D DistPoint3D = new Point3D();
            double? DistLin;
        ...
        public static Point3D LinesIntersectPoint(Line3D Line1, Line3D Line2)
        {
            ...
            Point2D IntersectPoint2D = new Point2D();
        ...
        /// <remarks></remarks>
        public static double DistantionPointToLine(Point2D Point, Line2D Line)
        {
            ...
            double Perimetr = 0;
            double S = 0;
            Point2D LinePt2 = new Point2D();
            //Вторая точка линии
            PointCalculator L = new PointCalculator();
        ...
        /// <remarks></remarks>
        public static double? DistantionPointToLine(Point3D Point, Line3D Line)
        {
