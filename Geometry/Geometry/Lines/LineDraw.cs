...
namespace GeometryObjects
{
    ...
    {
        public PointDraw PointDraw = new PointDraw();
        ...
        {
            PointDraw.Pen_LinkLineXoY_toX = PenLinkLineXoYtoX;
            PointDraw.Pen_LinkLineXoY_toY = PenLinkLineXoYtoY;
            PointDraw.Pen_LinkLineXoZ_toX = PenLinkLineXoZtoX;
            PointDraw.Pen_LinkLineXoZ_toZ = PenLinkLineXoZtoZ;
            PointDraw.Pen_LinkLineYoZ_toY = PenLinkLineYoZtoY;
            PointDraw.Pen_LinkLineYoZ_toZ = PenLinkLineYoZtoZ;
        }
        /// <summary>
        ...
        public LineDraw(Line3D Line3DSource)
        {
            ...
            LineOfPlan1X0YPositionByPicture = CnvLine3DProjection(Line3DSource.LineOfPlan1_X0Y);
            LineOfPlan2X0ZPositionByPicture = CnvLine3DProjection(Line3DSource.LineOfPlan2_X0Z);
            LineOfPlan3Y0ZPositionByPicture = CnvLine3DProjection(Line3DSource.LineOfPlan3_Y0Z);
        }
        /// <summary>
        /// Инициализация нового экземпляра PointDraw
        /// </summary>
        ...
        public LineDraw(Line3D line3DSource, Pen penPointsX0Y,
                        Pen penPointsX0Z,
                        Pen penPointsY0Z,
                        Pen penLineX0Y,
                        Pen penLineX0Z,
        ...
        {
            if (line3DSource.LineOfPlan1_X0Y != null)
            {
                PenPointsX0Y = penPointsX0Y;
                PenLineX0Y = penLineX0Y;
                LineOfPlan1X0YPositionByPicture = LinePositionCorrection(CnvLine3DProjection(line3DSource.LineOfPlan1_X0Y), frameCentreSource);
                LineOfPlan1X0YPositionByFrame = LinePositionCorrection(CnvLine3DProjection(line3DSource.LineOfPlan1_X0Y), PenPointsX0Y.Width, frameCentreSource);

            }
            if (line3DSource.LineOfPlan2_X0Z != null)
            {
                PenPointsX0Z = penPointsX0Z;
                PenLineX0Z = penLineX0Z;
                LineOfPlan2X0ZPositionByPicture = LinePositionCorrection(CnvLine3DProjection(line3DSource.LineOfPlan2_X0Z), frameCentreSource);
                LineOfPlan2X0ZPositionByFrame = LinePositionCorrection(CnvLine3DProjection(line3DSource.LineOfPlan2_X0Z), PenPointsX0Z.Width, frameCentreSource);

            }
            if (line3DSource.LineOfPlan3_Y0Z != null)
            {
                PenPointsY0Z = penPointsY0Z;
                PenLineY0Z = penLineY0Z;
                LineOfPlan3Y0ZPositionByPicture = LinePositionCorrection(CnvLine3DProjection(line3DSource.LineOfPlan3_Y0Z), frameCentreSource);
                LineOfPlan3Y0ZPositionByFrame = LinePositionCorrection(CnvLine3DProjection(line3DSource.LineOfPlan3_Y0Z), PenPointsY0Z.Width, frameCentreSource);
        ...
        public LineDraw(LineOfPlan1X0Y LineOfPlan1X0YSource, LineOfPlan2X0Z LineOfPlan2X0ZSource, LineOfPlan3Y0Z LineOfPlan3Y0ZSource)
        {
            ...
            {
                LineOfPlan1X0YPositionByFrame = new Line2D();
                LineOfPlan1X0YPositionByPicture = CnvLine3DProjection(LineOfPlan1X0YSource);
            }
            if (LineOfPlan2X0ZSource != null)
            {
                LineOfPlan2X0ZPositionByFrame = new Line2D();
                LineOfPlan2X0ZPositionByPicture = CnvLine3DProjection(LineOfPlan2X0ZSource);
            }
            if (LineOfPlan3Y0ZSource != null)
            {
                LineOfPlan3Y0ZPositionByFrame = new Line2D();
                LineOfPlan3Y0ZPositionByPicture = CnvLine3DProjection(LineOfPlan3Y0ZSource);
            }
        }
        /// <summary>
        /// Инициализация нового экземпляра PointDraw
        ...
        public LineDraw(LineOfPlan1X0Y LineOfPlan1X0YSource, LineOfPlan2X0Z LineOfPlan2X0ZSource, LineOfPlan3Y0Z LineOfPlan3Y0ZSource, Point FrameCentreSource)
        {
            ...
            {
                LineOfPlan1X0YPositionByPicture = CnvLine3DProjection(LineOfPlan1X0YSource);
                LineOfPlan1X0YPositionByFrame = LinePositionCorrection(LineOfPlan1X0YPositionByPicture, PenLineX0Y.Width, FrameCentreSource);

            }
            if (LineOfPlan2X0ZSource != null)
            {
                LineOfPlan2X0ZPositionByPicture = CnvLine3DProjection(LineOfPlan2X0ZSource);
                LineOfPlan2X0ZPositionByFrame = LinePositionCorrection(LineOfPlan2X0ZPositionByPicture, PenLineX0Z.Width, FrameCentreSource);

            }
            if (LineOfPlan3Y0ZSource != null)
            {
                LineOfPlan3Y0ZPositionByPicture = CnvLine3DProjection(LineOfPlan3Y0ZSource);
                LineOfPlan3Y0ZPositionByFrame = LinePositionCorrection(LineOfPlan3Y0ZPositionByPicture, PenLineY0Z.Width, FrameCentreSource);
                        ...
                        Point frameCentreSource)
        {
            if (lineOfPlan1X0YSource != null)
            {
                PenPointsX0Y = penPointsX0Y;
                PenLineX0Y = penLineX0Y;
                LineOfPlan1X0YPositionByPicture = LinePositionCorrection(CnvLine3DProjection(lineOfPlan1X0YSource), frameCentreSource);
                LineOfPlan1X0YPositionByFrame = LinePositionCorrection(CnvLine3DProjection(lineOfPlan1X0YSource), PenPointsX0Y.Width, frameCentreSource);
            ...
            if (lineOfPlan2X0ZSource != null)
            {
                PenPointsX0Z = penPointsX0Z;
                PenLineX0Z = penLineX0Z;
                LineOfPlan2X0ZPositionByPicture = LinePositionCorrection(CnvLine3DProjection(lineOfPlan2X0ZSource), frameCentreSource);
                LineOfPlan2X0ZPositionByFrame = LinePositionCorrection(CnvLine3DProjection(lineOfPlan2X0ZSource), PenPointsX0Z.Width, frameCentreSource);
            ...
            if (lineOfPlan3Y0ZSource != null)
            {
                PenPointsY0Z = penPointsY0Z;
                PenLineY0Z = penLineY0Z;
                LineOfPlan3Y0ZPositionByPicture = LinePositionCorrection(CnvLine3DProjection(lineOfPlan3Y0ZSource), frameCentreSource);
                LineOfPlan3Y0ZPositionByFrame = LinePositionCorrection(CnvLine3DProjection(lineOfPlan3Y0ZSource), PenPointsY0Z.Width, frameCentreSource);
        ...
        {
            DrawLinkLine(line3DSource.LineOfPlan1_X0Y, line3DSource.LineOfPlan2_X0Z, line3DSource.LineOfPlan3_Y0Z, frame2DCentre, ref graphicsSource);
        }
