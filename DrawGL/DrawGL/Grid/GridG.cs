...
namespace DrawG
{
    ...
    class GridG
    {
        ...
        public int GridStepOfHeight
        {
            get
            {
                return (int)this.GridDefaultSetting.StepY;
            }
            set
            {
                this.GridDefaultSetting.StepY = GridStepOfHeight;
            }
        }
        /// <summary>
        ...
        public int GridStepOfWidth
        {
            get
            {
                return (int)this.GridDefaultSetting.StepX;
            }
            set
            {
                this.GridDefaultSetting.StepX = GridStepOfWidth;
            }
        }
        /// <summary>
        ...
        public bool GridFlagDraw
        {
            get
            {
                return this.GridDefaultSetting.FlagDraw;
            }
            set
            {
                this.GridDefaultSetting.FlagDraw = GridFlagDraw;
            }
        }
        /// <summary>
