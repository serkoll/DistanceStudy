...
namespace GraphicsModule.Geometry.MatrixEvalution
{
    ...
    ///  Расширяет класс ArrayNxM_Operation для работы с массивами As Integer(,)
    /// </summary>
    /// <remarks>Copyright © Polozkov V. Yury, 2014</remarks>
    public class ArrayNxM_Integer
    {


        private ArrayControl ArrayControl_VarInt = new ArrayControl();
        /// <summary>
        ...
        /// <remarks> </remarks>
        public int[,] MoveUnit(int[,] ArrayNxM_Source, int NumRow, int NumCol)
        {
            ...
            MrxTrans = new int[ArrayNxM_Source.GetUpperBound(0) + 1, ArrayNxM_Source.GetUpperBound(1) + 1];
            //Установка размерности MrxTrans(,)
            MrxTransInt = new int[MrxTrans.GetUpperBound(0) + 1, MrxTrans.GetUpperBound(1) + 1];
            //Установка размерности MrxTransInt(,)
            MrxTrans = (int[,])ArrayNxM_Source.Clone();
            MrxTransInt = (int[,])MrxTrans.Clone();
        ...
        Calc_Step3:
            ...
            MrxTrans = (int[,])MrxTransInt.Clone();
        ...
        Calc_Step4б:
            ...
            while (j <= MrxTrans.GetUpperBound(1))
            {
                ...
                {
                    if ((int)MrxTrans.GetValue(i, j) == 0 | MrxTrans.GetValue(i, j) == MrxTrans.GetValue(NumRow, NumCol))
                    {
                        goto CollZero_j;
                    }
                    else
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source" >Заданный массив</param>
        public int[,] MoveToDown_ZeroRows(int[,] ArrayNxM_Source)
        {
        ...
        public int[] IndexList_ZeroRows(int[,] ArrayNxM_Source)
        {
            int i = 0;
            int j = 0;
            ...
            while (i <= ArrayNxM_Source.GetUpperBound(0))
            {
                ...
                {
                    if ((int)ArrayNxM_Source.GetValue(i, j) == 0)
                    {
                        VarRow = true;
                    }
                    else
        ...
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        /// <remarks>Возвращает в списке -1, если нулевые строки в массиве отсутсвуют</remarks>
        public int[] IndexList_ZeroCols(int[,] ArrayNxM_Source)
        {
            int i = 0;
            int j = 0;
        ...
        public bool? ZeroRow(int[,] ArrayNxM_Source, int NumRow)
        {
            int j = 0;
            ...
            while (j <= ArrayNxM_Source.GetUpperBound(1))
            {
                if ((int)ArrayNxM_Source.GetValue(NumRow, j) == 0)
                {
                    VarRow = true;
                }
                else
        ...
        public bool? ZeroCol(int[,] ArrayNxM_Source, int NumCol)
        {
            int i = 0;
            ...
            while (i <= ArrayNxM_Source.GetUpperBound(0))
            {
                if ((int)ArrayNxM_Source.GetValue(i, NumCol) == 0)
                {
                    VarColl = true;
                }
                else
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public int[,] ReplaceRows(int[,] ArrayNxM_Source, int NumRow1, int NumRow2)
        {
            int j = 0;
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public int[,] ReplaceCols(int[,] ArrayNxM_Source, int NumCol_1, int NumCol_2)
        {
            int i = 0;
            //Переменная номера строки
            int[,] MrxTrans = null;
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public bool ArrayNxM_Zero(int[,] ArrayNxM_Source)
        {
            int i = 0;
            int j = 0;
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public bool Row1IsRow2(int[,] ArrayNxM_Source, int NumRow1, int NumRow2)
        {
            int j = 0;
            //Переменная номеров столбцов
            bool VarRow = false;
        ...
        /// </summary>
        /// <param name="ArrayNxM_Source">Заданный массив</param>
        public bool Col1IsCol2(int[,] ArrayNxM_Source, int NumCol1, int NumCol2)
        {
            int i = 0;
            //Переменная номеров строк
            bool VarColl = false;
        ...
        public ArrayList Cut_ColAsList(int NumСol, int RowStart, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(RowStart, NumСol, SourceArray) == false)
            {
                return null;
            }
        ...
        public ArrayList Cut_ColAsList(int NumСol, int RowStart, int RowEnd, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_ColAndIndexRow(RowStart, RowEnd, NumСol, SourceArray) == false)
            {
                return null;
            }
            ArrayList NameGrp = new ArrayList();
        ...
        public ArrayList Cut_RowAsList(int NumRow, int ColStart, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(NumRow, ColStart, SourceArray) == false)
            {
                return null;
            }
            ArrayList NameGrp = new ArrayList();
        ...
        public ArrayList Cut_RowAsList(int NumRow, int ColStart, int ColEnd, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_RowAndIndexCol(NumRow, ColStart, ColEnd, SourceArray) == false)
            {
                return null;
            }
            ArrayList NameGrp = new ArrayList();
        ...
        /// <param name="RowStart">Номер строки, задающей начало записи данных</param>
        public int[] Cut_Col(int NumCol, int RowStart, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(RowStart, NumCol, SourceArray) == false)
            {
                return null;
            }
            int[] ColArray = null;
        ...
        /// <param name="NumCol">Номер столбца</param>
        /// <param name="RowStart">Номер строки, задающей начало записи данных</param>
        public int[] Cut_Col(int NumCol, int RowStart, int RowEnd, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_ColAndIndexRow(RowStart, RowEnd, NumCol, SourceArray) == false)
            {
                return null;
            }
            int[] ColArray = null;
        ...
        /// <param name="NumRow">Номер строки</param>
        /// <param name="ColStart">Номер столбца, задающего начало записи данных</param>
        public int[] Cut_Row(int NumRow, int ColStart, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(NumRow, ColStart, SourceArray) == false)
            {
        ...
        public int[,] Cut_PartArray(int RowStart, int ColStart, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(RowStart, ColStart, SourceArray) == false)
            {
                return null;
            }
            ...
            {
                int[,] ArrayOut = new int[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 1];
        ...
        public int[,] Cut_PartArray(int RowStart, int RowEnd, int ColStart, int ColEnd, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(RowStart, RowEnd, ColStart, ColEnd, SourceArray) == false)
            {
                return null;
            }
            int[,] PartArray = new int[RowEnd + 1, ColEnd + 1];
            for (int i = RowStart; i <= RowEnd; i++)
            {
                for (int j = ColStart; j <= ColEnd; j++)
                {
        ...
        public int[,] ClearArrayAroundPart(int RowStart, int RowEnd, int ColStart, int ColEnd, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(RowStart, RowEnd, ColStart, ColEnd, SourceArray) == false)
            {
        ...
        public int[,] PartArrayToArrayCopy(int RowStart, int RowEnd, int ColStart, int ColEnd, int[,] SourceArray, int[,] DestinationArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(RowStart, RowEnd, ColStart, ColEnd, SourceArray) == false)
            {
            ...
            else
            {
                ...
                {
                    DestArrayVar = (int[,])DestinationArray.Clone();
                    //Копия выходного массива
                    DestinationArray = new int[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 1];
                }
                else if (SourceArray.GetUpperBound(0) > DestinationArray.GetUpperBound(0) & SourceArray.GetUpperBound(1) <= DestinationArray.GetUpperBound(1))
                {
                    DestArrayVar = (int[,])DestinationArray.Clone();
                    //Копия выходного массива
                    DestinationArray = new int[SourceArray.GetUpperBound(0) + 1, DestArrayVar.GetUpperBound(1) + 1];
                }
                else if (SourceArray.GetUpperBound(0) <= DestinationArray.GetUpperBound(0) & SourceArray.GetUpperBound(1) > DestinationArray.GetUpperBound(1))
                {
                    DestArrayVar = (int[,])DestinationArray.Clone();
                    //Копия выходного массива
                    DestinationArray = new int[DestArrayVar.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 1];
                }
                else
                {
                    goto DataCopy;
        ...
        /// <param name="ColStart">Номер начального столбца копируемой области</param>
        /// <remarks>Вставляет содержимое в интервал, определяемый заданными номерами строк и столбцов</remarks>
        public int[,] PartArrayToArrayCopy(int RowStart, int ColStart, int[,] SourceArray, int[,] DestinationArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(RowStart, ColStart, SourceArray) == false)
            {
        ...
        public int[,] CnvArrayListToArray2D(ArrayList SourceArrayList)
        {
            //Возвращает двумерный массив, содержащий в первой колонке номера ячеек ArrayList, во второй - значения ячеек ArrayList
            int[,] Array2D_Out = new int[SourceArrayList.Count, 2];
        ...
        /// <remarks>Вставляет содержимое в интервал, определяемый заданными номерами строк и столбцов</remarks>
        public bool? Control_RowValue(object Value, int NumRow, int ColStart, int[,] SourceArray)
        {
            //Контроль значений заданных индексов
            if (ArrayControl_VarInt.Control_IndexRowAndCol(NumRow, ColStart, SourceArray) == false)
            {
            ...
            for (int j = ColStart; j <= SourceArray.GetUpperBound(1); j++)
            {
                //контроль существания зщаданного значения в текущей ячейке
                if (SourceArray.GetValue(NumRow, j) == Value)
                {
                    return true;
                }
            }
        ...
        /// <param name="ColStart">Номер столбца, задающего начало контролируемой области</param>
        /// <remarks>Вставляет содержимое в интервал, определяемый заданными номерами строк и столбцов</remarks>
        public int[] IndexRowsOfNonValue(object Value, int NumRow, int ColStart, int[,] SourceArray)
        {
            //Возвращает номера строк двумерного массива, в которых нет заданного значения, начиная с заданной строки и заданного столбца
        ...
        //------------------------------------------------- Вставка и замена столбцов в заданный массив (As Integer) ----------------------------------------------------
        ...
        /// <returns>Возвращает двумерный массив As Integer</returns>
        /// <remarks>
        ...
        /// </remarks>
        public int[,] Array_CollAdd(int IndexAddColl, int[,] SourceArray)
        {
            int[,] ArrayVar = new int[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + 2];
        ...
        /// </remarks>
        public int[,] Array_CollAdd(int CountColls, int[,] SourceArray, int IndexForAddFirstColl)
        {
            int[,] ArrayVar = new int[SourceArray.GetUpperBound(0) + 1, SourceArray.GetUpperBound(1) + CountColls + 1];
        ...
        /// </remarks>
        public int[,] Array_CollAdd(int[] AddArray, int[,] SourceArrayForAdd, int IndexForCollAdd)
        {
            int[,] ArrayVar = new int[SourceArrayForAdd.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + 2];
            //Выходной массив, размерностью больше на один столбец заданного массива
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданного столбца
            ...
            {
                ArrayVar = new int[AddArray.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + 2];
            }
            //Вставка нового столбца, имеющего индекс, равный нулю
        ...
        /// </remarks>
        public int[,] Array_CollAdd(int[,] AddArray, int[,] SourceArrayForAdd, int IndexForAddFirstColl)
        {
            int[,] ArrayVar = null;
            //Выходной массив
            int i = 0;
            ...
            {
                ArrayVar = new int[AddArray.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + AddArray.GetUpperBound(1) + 2];
            }
            else
            {
                ArrayVar = new int[SourceArrayForAdd.GetUpperBound(0) + 1, SourceArrayForAdd.GetUpperBound(1) + AddArray.GetUpperBound(1) + 2];
        ...
        /// </remarks>
        public int[,] Array_CollСhange(int[] СhangeArray, int[,] SourceArrayForСhange, int IndexOfChangeColl)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданного столбца
        ...
        /// При значении добавляемого массива, равном "Nothing" возвращается исходный массив.
        /// </remarks>
        public int[,] Array_CollСhange(int[,] СhangeArray, int[,] SourceArrayForСhange, int IndexFirstChangeColl)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданного столбца
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------------------
        //------------------------------------------------- Вставка и замена строк в заданный массив (As Integer) ------------------------------------------------------
        ...
        /// </remarks>
        public int[,] Array_RowAdd(int IndexAddRow, int[,] SourceArray)
        {
            int[,] ArrayVar = new int[SourceArray.GetUpperBound(0) + 2, SourceArray.GetUpperBound(1) + 1];
        ...
        /// </remarks>
        public int[,] Array_RowAdd(int CountRows, int[,] SourceArray, int IndexForAddFirstRow)
        {
            int[,] ArrayVar = new int[SourceArray.GetUpperBound(0) + CountRows + 1, SourceArray.GetUpperBound(1) + 1];
        ...
        /// </remarks>
        public int[,] Array_RowAdd(int[] AddArray, int[,] SourceArrayForAdd, int IndexForRowAdd)
        {
            int[,] ArrayVar = new int[SourceArrayForAdd.GetUpperBound(0) + 2, SourceArrayForAdd.GetUpperBound(1) + 1];
            //Выходной массив, размерностью больше на одну строку заданного массива
            int i = 0;
            int j = 0;
            ...
            {
                ArrayVar = new int[SourceArrayForAdd.GetUpperBound(0) + 2, AddArray.GetUpperBound(0) + 1];
            }
            //Вставка новой строки, имеющей индекс, равный нулю
            if (IndexForRowAdd == 0)
            {
        ...
        /// При значении добавляемого массива, равном "Nothing" возвращается исходный массив.
        /// </remarks>
        public int[,] Array_RowAdd(int[,] AddArray, int[,] SourceArrayForAdd, int IndexForAddFirstRow)
        {
            int[,] ArrayVar = null;
            //Выходной массив
            int i = 0;
            ...
            {
                ArrayVar = new int[SourceArrayForAdd.GetUpperBound(0) + AddArray.GetUpperBound(0) + 2, AddArray.GetUpperBound(1) + 1];
            }
            else
            {
                ArrayVar = new int[SourceArrayForAdd.GetUpperBound(0) + AddArray.GetUpperBound(0) + 2, SourceArrayForAdd.GetUpperBound(1) + 1];
        ...
        /// </remarks>
        public int[,] Array_RowСhange(int[] СhangeArray, int[,] SourceArrayForAdd, int IndexOfChangeRow)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданной строки
        ...
        /// При значении добавляемого массива, равном "Nothing" возвращается исходный массив.
        /// </remarks>
        public int[,] Array_RowСhange(int[,] СhangeArray, int[,] SourceArrayForAdd, int IndexFirstChangeRow)
        {
            int i = 0;
            int j = 0;
            //Контроль значения индекса заданной строки
