    ...
    public class Segment3D : IObject
    {
        ...
        public Segment3D(SegmentOfPlane1X0Y linePi1, SegmentOfPlane2X0Z linePi2)
        {
                     ...
                     linePi1.Point1.X == linePi2.Point0.X)
            {
                ...
                Point1 = new Point3D(ConvertObjectsExtensions.ToPoint2D(linePi1.Point0), linePi2.Point1.Z);
                SegmentOfPlane1X0Y = linePi1;
                SegmentOfPlane2X0Z = linePi2;
        ...
        {
            SegmentOfPlane1X0Y.DrawSegmentOnly(settings, frameCenter, g);
            SegmentOfPlane2X0Z.DrawSegmentOnly(settings, frameCenter, g);
            SegmentOfPlane3Y0Z.DrawSegmentOnly(settings, frameCenter, g);
