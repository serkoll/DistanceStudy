...
namespace GraphicsModule.Geometry.Objects.Planes
{
    public class PlaneSpace
    {
        ...
        public Point3D PlaneCentre = new Point3D();
        public double A;
        public double B;
        public double C;
        ...
        public PlaneSpace()
        {
            ...
            dynamic ZeroAxis1 = default(Line3D);
            Line3D ZeroAxis2 = new Line3D();
            dynamic PlaneCentre = default(Point3D);
            dynamic Pt1 = default(Point3D);
        ...
        public PlaneSpace(double A, double B, double C, double D, Point3D PlaneCentre)
        {
            ...
            if (PointOfPlanePosition(PlaneCentre, Plane) != 0)
            {
        ...
        public PlaneSpace(Point3D Point1, Point3D Point2, Point3D Point3)
        {
            ...
            dynamic LineVar = default(Line3D);
            dynamic Line1 = default(Line3D);
            dynamic Line2 = default(Line3D);
            Line3D Line3 = new Line3D();
            Point3D PtPeres = new Point3D();
        ...
        public Point3D GetPointOfPlane(double lx, double ly, PlaneSpace Plane)
        {
            //Свойство, возвращающее координаты 3D точки на 3D плоскости по параметрам lx и ly (координаты x и y)
            return (new Point3D(Plane.PlaneCentre.X + lx, Plane.PlaneCentre.Y + ly, (Plane.A * (Plane.PlaneCentre.X + lx) + Plane.B * (Plane.PlaneCentre.Y + ly) + Plane.D) / -Plane.C));
        }
        ...
        public void NewPlaneCentre(PlaneSpace Plane, Point3D NewPlaneCentre)
        {
            ...
            if (PointOfPlanePosition(NewPlaneCentre, Plane) == 0)
            {
        ...
        public void PlaneSpaceCreation(Point3D Point1, Point3D Point2, Point3D Point3)
        {
            //Конструктор создания плоскости по трем точкам
            PlaneSpace PlaneSpaceNew = new PlaneSpace(Point1, Point2, Point3);
            PlaneCentre = PlaneSpaceNew.PlaneCentre;
            //Начальная точка плоскости
            //Коэффициенты уравнения общего вида плоскости
            A = PlaneSpaceNew.A;
            B = PlaneSpaceNew.B;
        ...
        public void PlaneSpaceCreation(Line3D Line1, Line3D Line2)
        {
            //Конструктор задания плоскости двумя прямыми
        ...
        public void PlaneSpaceCreation(Line3D Line, Point3D Point)
        {
            //Конструктор задания плоскости точкой и прямой
        ...
        public void PlaneSpaceCreation(Line3D Line1, Line3D Line2, Line3D Line3)
        {
            //Конструктор задания плоскости тремя прямыми
        ...
        public Line3D NormalVectorOfPlane(PlaneSpace Plane)
        {
            ...
            //Расчет
            dynamic FrameCentre3D = default(Point3D);
            Point3D NormalVectorEndPt = new Point3D();
            Line3D NormalVector = new Line3D();
            FrameCentre3D.X = 0;
            FrameCentre3D.Y = 0;
            FrameCentre3D.Z = 0;
        ...
        public void ParallelePlaneToPlaneFromPoint(Point3D Point, PlaneSpace Plane)
        {
        ...
        public void ParallelePlaneTo2LineFromPoint(Point3D Point, Line3D Line1, Line3D Line2)
        {
            ...
            //---------------------
            A = MrxVar.detMrx2x2(Deti);
            B = -MrxVar.detMrx2x2(Detj);
            C = MrxVar.detMrx2x2(Detk);
            D = A * (-Point.X) + B * (-Point.Y) + C * (-Point.Z);
            //Расчет свободного коэффициента новой плоскости
            PlaneCentre.X = A;
            PlaneCentre.Y = B;
            ...
            PlaneSpace PlaneVar = new PlaneSpace(A, B, C, D, PlaneCentre);
        ...
        public void PerpendicularePlaneTo2PlanesFromPoint(Point3D Point, PlaneSpace Plane1, PlaneSpace Plane2)
        {
            //Конструктор создания плоскости, проходящей через заданную точку, перпендикулярно двум заданным плоскостям
            //Контроль корректности задания плоскости
            if (PlanFalse(Plane1) == true | PlanFalse(Plane2) == true)
            {
            ...
            if (PlanToPlanParallele(Plane1, Plane2) == true)
            {
            ...
            else
            {
                ...
                A = MrxVar.detMrx2x2(Ak);
                B = -MrxVar.detMrx2x2(Bk);
                C = MrxVar.detMrx2x2(Ck);
        ...
        public Point3D ProectionPointOnPlane(Point3D Point, PlaneSpace Plane)
        {
            ...
            if (PointOfPlanePosition(Point, Plane) == 0)
            {
                return Point;
            }
            else
            {
                PerpendicularPtToPlane = PerpendicularPointToPlane(Point, Plane);
                ProectionPoint = IntersectionPoint_LineAndPlan(PerpendicularPtToPlane, Plane);
        ...
        public Line3D PerpendicularPointToPlane(Point3D Point, PlaneSpace Plane)
        {
            //Функция задает перпендикулярную прямую из заданной точки на заданную плоскость
            dynamic NormalVector = default(Line3D);
            Line3D PerpendicularLine = new Line3D();
        ...
        public double? DistantionPointToPlanAbs(Point3D Point, PlaneSpace Plane)
        {
        ...
        public double? DistantionPointToPlan(Point3D Point, PlaneSpace Plane)
        {
        ...
        public double DistantionLineToPlan(Line3D Line, PlaneSpace Plane)
        {
            ...
            dynamic LinePt = default(Point3D);
            ...
            if (IntersectionLineAndPlan(Line, Plane) == true | LineOfPlan(Line, Plane) == true)
            {
        ...
        public double? DistantionPlanToPlanAbs(PlaneSpace Plane1, PlaneSpace Plane2)
        {
            ...
            dynamic FrameZeroPoint = default(Point3D);
            dynamic PointPlane1 = default(Point3D);
            dynamic PointPlane2 = default(Point3D);
            Point3D PointVar = new Point3D();
            ...
            if (PlanToPlanParallele(Plane1, Plane2) == true)
            {
                ...
                //Второй способ
                DistPlanToPlan1 = DistPlaneToZeroPoint(Plane1);
                //Расстояние от начала системы координат 3D базиса до 1-й плоскости
                DistPlanToPlan2 = DistPlaneToZeroPoint(Plane2);
        ...
        public int? PointOfPlanePosition(Point3D Point, PlaneSpace Plane)
        {
        ...
        public bool? PlanToPlanPerpendiculare(PlaneSpace Plane1, PlaneSpace Plane2)
        {
            ...
            else
            {
                ...
                if (Math.Abs(Plane1.A * Plane2.A + Plane1.B * Plane2.B + Plane1.C * Plane2.C) <= SolveErrorPl)
                {
                    return true;
                }
                else
        ...
        AnglePlans:
            ...
            if (Math.Abs((double)PlansAngle) - 90 <= SolveErrorPl)
            {
                return true;
            }
            else
        ...
        public bool? PlanToPlanParallele(PlaneSpace Plane1, PlaneSpace Plane2)
        {
            ...
            else
            {
                ...
                if (Math.Abs(Plane1.A * Plane2.B - Plane1.B * Plane2.A) <=
                    SolveErrorPl & Math.Abs(Plane1.B * Plane2.C - Plane2.B * Plane1.C) <=
                    SolveErrorPl & Math.Abs(Plane1.A * Plane2.C - Plane2.A * Plane1.C) <=
                    SolveErrorPl)
                {
                    return true;
                }
        ...
        public double AngleLineToPlan(Line3D Line, PlaneSpace Plane)
        {
        ...
        public Point3D IntersectionPoint_LineAndPlan(Line3D Line, PlaneSpace Plane)
        {
            ...
            else if (LineOfPlan(Line, Plane) == true)
            {
        ...
        public Point3D PointIntersectionOf3Plans(PlaneSpace Plane1, PlaneSpace Plane2, PlaneSpace Plane3)
        {
            ...
            EqSysCalculation VarSolution = new EqSysCalculation();
            //Переменная для расчета определителя и ранга матриц
            int i = 0;
            int j = 0;
            //Переменные цикла
            Point3D PointIntersect = new Point3D();
            //Точка пересечения плоскостей
            Line3D LineVar = new Line3D();
            //Контроль правильности задания плоскостей
            if (PlanFalse(Plane1) == true | PlanFalse(Plane2) == true | PlanFalse(Plane3) == true)
            {
        ...
        public double? DirectingCos(int CoordinateIndex, Point3D VectorForwardPoint, Point3D VectorEndPoint)
        {
        ...
        public double? DirectingCos(double Coordinate, Point3D VectorEndPoint)
        {
        ...
        public bool IntersectionLineAndPlan(Line3D Line, PlaneSpace Plane)
        {
        ...
        public bool LineToPlanParallele(Line3D Line, PlaneSpace Plane)
        {
        ...
        public bool LineToPlanePerpendiculare(Line3D Line, PlaneSpace Plane)
        {
            ...
            //    Return True
            if (Math.Abs(Plane.A * Line.ky - Plane.B * Line.kx) >= SolveErrorPl & Math.Abs(Plane.A * Line.kz - Plane.C * Line.kx) >=
                SolveErrorPl & Math.Abs(Plane.B * Line.kz - Plane.C * Line.ky) >= SolveErrorPl)
            {
                return true;
            }
            else
