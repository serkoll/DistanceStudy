...
namespace GraphicsModule.Configuration.Access.Structures
{
    ...
    public class PlanesAccess
    {
        public PlanesAccess()
        {
            IsPlanesEnabled = IsPlane2DEnabled = IsPlane3DEnabled = IsPlaneOfPlane1X0YEnabled = IsPlaneOfPlane2X0ZEnabled = IsPlaneOfPlane3Y0ZEnabled = IsGeneratePlane3DEnabled = true;
        }
