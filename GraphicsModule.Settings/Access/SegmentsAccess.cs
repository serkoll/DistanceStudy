...
namespace GraphicsModule.Configuration.Access.Structures
{
    ...
    public class SegmentsAccess
    {
        ...
        {
            IsSegmentsEnabled = IsSegment2DEnabled = IsSegment3DEnabled = IsSegmentOfPlane1X0YEnabled = IsSegmentOfPlane2X0ZEnabled = IsSegmentOfPlane3Y0ZEnabled = IsGenerateSegment3DEnabled = true;
        }
