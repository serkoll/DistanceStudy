...
namespace GraphicsModule.Configuration.Controls
{
    public partial class AxisSettingsControl : UserControl
    {
        ...
        {
            InitializeComponent();
            AxisS = ConfigurationForm.ValueS.AxisS;
            ...
            colorBoxX.BackColor = ConfigurationForm.ValueS.AxisS.ColorX;
            colorBoxY.BackColor = ConfigurationForm.ValueS.AxisS.ColorY;
            colorBoxZ.BackColor = ConfigurationForm.ValueS.AxisS.ColorZ;
        }
