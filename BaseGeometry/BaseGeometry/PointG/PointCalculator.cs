...
namespace GeomObjects.Points
{
    ...
    {
        private Point2D PointCalcVar2D = new GeomObjects.Points.Point2D();//Переменная для действий с 2D точками
        private Point3D PointCalcVar3D = new GeomObjects.Points.Point3D();  //Переменная для действий с 3D точками
        ...
        { Point3D Point1L = new Point3D(); return this.PointDistantion(Point1L, Point); }//Функция возвращает значение расстояния от начала координат до 3D точки
        ...
        /// <remarks></remarks>
        public void PointDelta(Point2D Point1, Point2D Point2, ref double Delta_X, ref double Delta_Y) { Delta_X = this.PointDeltaX(Point1, Point2); Delta_Y = this.PointDeltaY(Point1, Point2); }//Возвращает приращения координат X и Y от первой 2D точки до второй 2D точки
        ...
        /// <summary>Возвращает (по ссылке "ref") приращения координат X и Y от первой 2D точки до второй 2D точки</summary>
        /// <remarks></remarks>
        public void PointDelta(Point2D Point1, Point2D Point2, ref double Delta_X, ref double Delta_Y, ref double Delta_Z) { Delta_X = this.PointDeltaX(Point1, Point2); Delta_Y = this.PointDeltaY(Point1, Point2); Delta_Z = 0; }

        /// <summary>Возвращает (по ссылке "ref") приращения координат X и Y от первой 3D точки до второй 3D точки</summary>
        /// <remarks></remarks>
        public void PointDelta(Point3D Point1, Point3D Point2, ref double Delta_X, ref double Delta_Y, ref double Delta_Z) { Delta_X = this.PointDeltaX(Point1, Point2); Delta_Y = this.PointDeltaY(Point1, Point2); Delta_Z = this.PointDeltaZ(Point1, Point2); }
