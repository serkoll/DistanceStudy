...
namespace GeomObjects.Points
{
    ...
    public class Point3D : Point2D
    {
        ...
        public Point3D() { new Points.Point2D(); this.Z = 0; }//Конструктор, устанавливающий исходные значения координат 3D точки

        /// <summary>Инициализирует новый экземпляр 3D точки с указанными координатами</summary>
        /// <remarks></remarks>
        public Point3D(double X, double Y, double Z) { new Points.Point2D(X, Y); this.Z = Z; }//Конструктор, устанавливающий пользовательские значения координат 3D точки

        /// <summary>Инициализирует новый экземпляр 3D точки</summary>
        /// <remarks></remarks>
        public Point3D(Point3D Point3D_Source) { new Points.Point2D(Point3D_Source.X, Point3D_Source.Y); this.Z = Point3D_Source.Z; }//Конструктор, устанавливающий пользовательские значения координат 3D точки

        /// <summary>Преобразует 2D точку в 3D точку путем добавления третьей координаты</summary>
        /// <remarks></remarks>
        public Point3D(Point2D Point2D_Source, double Z_Value) { new Points.Point2D(Point2D_Source.X, Point2D_Source.Y); this.Z = Z_Value; }//Конструктор преобразования двумерной точки в трехмерную, с установкой заданного значения третьей координаты (Z)

        /// <summary>Преобразует 2D точку в 3D точку путем добавления третьей координаты</summary>
        /// <remarks></remarks>
        public void TransformPoint2DTo3D(Point2D Point2D_Source, double Z_Value) { base.X = Point2D_Source.X; base.Y = Point2D_Source.Y; this.Z = Z_Value; }//Метод преобразования двумерной точки в трехмерную, с установкой заданного значения третьей координаты (Z)
        ...
        public void TransformPoint2DTo3D(Point2D Point2D_Source) { base.X = Point2D_Source.X; base.Y = Point2D_Source.Y; this.Z = 0; }//Метод преобразования двумерной точки в трехмерную,//с установкой значения третьей координаты (Z) по умолчанию равной нулю
        ...
        public void PointMove(double dx, double dy, double dz) { base.X += dx; base.Y += dy; this.Z += dz; }//Конструктор перемещения на указанные величины по осям в 3D 
        ...
        {
            get { Points.PointOfPlan1X0Y Ptvar = new Points.PointOfPlan1X0Y(base.X, base.Y); return Ptvar; }
        ...
        /// <remarks></remarks>
        public Points.PointOfPlan2X0Z PointOfPlan2X0Z
        {
            get { Points.PointOfPlan2X0Z PtVar = new Points.PointOfPlan2X0Z(base.X, this.Z); return PtVar; }
            set { Points.PointOfPlan2X0Z PtVar = new Points.PointOfPlan2X0Z(Point.X, Point.Z); }
        ...
        /// <remarks></remarks>
        public Points.PointOfPlan3Y0Z PointOfPlan3Y0Z
        {
            get { Points.PointOfPlan3Y0Z PtVar = new Points.PointOfPlan3Y0Z(base.Y, this.Z); return PtVar; }
            set { Points.PointOfPlan3Y0Z PtVar = new Points.PointOfPlan3Y0Z(Point.Y, Point.Z); }
        }// Свойство проекции 3D точки на плоскость Y0Z + Считывание значений координат проекции точки

        public PointDraw Point3DDraw { get { return this.PointDraw_Var; } set { this.PointDraw_Var = value; } }
        ...
        /// <remarks></remarks>
        public PointOfPlan2X0Z PointOf2PlanX0Z(Point3D Point3D_Source) { Points.PointOfPlan2X0Z PtVar = new Points.PointOfPlan2X0Z(Point3D_Source.X, Point3D_Source.Z); return PtVar; }// Свойство проекции 3D точки на плоскость X0Y

        /// <summary>Возвращает проекцию 3D точки на плоскость X0Y пространственной системы координат</summary>
        /// <remarks></remarks>
        public PointOfPlan3Y0Z PointOf3PlanY0Z(Point3D Point3D_Source) { Points.PointOfPlan3Y0Z PtVar = new Points.PointOfPlan3Y0Z(Point3D_Source.Y, Point3D_Source.Z); return PtVar; }// Свойство проекции 3D точки на плоскость X0Y // PtVar.Y = Point.Y : PtVar.Z = Point.Z

        /// <summary>Конвертирует проекцию 3D точки в GeomObjects.Point2D</summary>
        /// <remarks></remarks>
        public Point2D ConvertPointOfPlanToPoint2D(PointOfPlan1X0Y Point_Source) { Points.PointOfPlan1X0Y PtVar = new Points.PointOfPlan1X0Y(); return PtVar.CnvPoint2D(Point_Source); }// Свойство проекции 3D точки на плоскость X0Y

        /// <summary>Конвертирует проекцию 3D точки в GeomObjects.Point2D</summary>
        /// <remarks></remarks>
        public Point2D ConvertPointOfPlanToPoint2D(PointOfPlan2X0Z Point_Source) { Points.PointOfPlan2X0Z PtVar = new Points.PointOfPlan2X0Z(); return PtVar.CnvPoint2D(Point_Source); }// Свойство проекции 3D точки на плоскость X0Z

        /// <summary> Конвертирует проекцию 3D точки в GeomObjects.Point2D</summary>
        /// <remarks></remarks>
        public Point2D ConvertPointOfPlanToPoint2D(PointOfPlan3Y0Z Point_Source) { Points.PointOfPlan3Y0Z PtVar = new Points.PointOfPlan3Y0Z(); return PtVar.CnvPoint2D(Point_Source); }// Свойство проекции 3D точки на плоскость Y0Z
        ...
        {//Функция задания 3D точки по 3-м проекциям без указания осей
            ...
            if (pointPi1 != null & pointPi2 != null & pointPi3 == null) { Point3DByProectVar = this.CreatePoint3DBy2Proections12(pointPi1, pointPi2, ref errorPoint3D, errorMsgBoxFlag); }
            else if (pointPi1 != null & pointPi2 == null & pointPi3 != null) { Point3DByProectVar = this.CreatePoint3DBy2Proections13(pointPi1, pointPi3, ref errorPoint3D, errorMsgBoxFlag); }
            else if (pointPi1 == null & pointPi2 != null & pointPi3 != null) { Point3DByProectVar = this.CreatePoint3DBy2Proections23(pointPi2, pointPi3, ref errorPoint3D, errorMsgBoxFlag); }
            else if (pointPi1 != null & pointPi2 != null & pointPi3 != null)
            {
                Point3DByProectVar = this.CreatePoint3DBy2Proections12(pointPi1, pointPi2, ref errorPoint3D, errorMsgBoxFlag);
                if (Point3DByProectVar == null) { return null; }//Контроль для проекций 1, 2
                Point3DByProectVar = this.CreatePoint3DBy2Proections13(pointPi1, pointPi3, ref errorPoint3D, errorMsgBoxFlag);
                if (Point3DByProectVar == null) { return null; }//Контроль для проекций 1, 3
                Point3DByProectVar = this.CreatePoint3DBy2Proections23(pointPi2, pointPi3, ref errorPoint3D, errorMsgBoxFlag);
        ...
        {//Функция задания 3D точки по 3-м проекциям без указания осей
            Point3D Point3DByProectVar = new GeomObjects.Points.Point3D();
        ...
        { //Контроль не заданных значений координат точки//Возвращает метку, соответсвующую координатам, для которых значения координат соответсвуют значению "Nothing"
            ...
            {
                ProectionError = GeomObjects.Points.PointsPositionControl.CoordinateValue.None;
                GeomObjects.Points.Point3D Point3DByTextVar = new GeomObjects.Points.Point3D(Convert.ToDouble(X_Text), Convert.ToDouble(Y_Text), Convert.ToDouble(Z_Text));
        ...
        {//Контроль не заданных значений координат точки//Возвращает метку, соответсвующую координатам, для которых значения координат соответсвуют значению "Nothing"
            ...
            GeomObjects.Points.Point3D Point3DByTextVar = new GeomObjects.Points.Point3D();//Точка для вывода
            ...
            //Расчет метки
            Point3DByTextVar = this.CreatePoint3DByText(X_Text, Y_Text, Z_Text, CoordinateValueVar);
            //Контроль меток для ввода наименований координат в комментарий
            if (CoordinateValueVar == GeomObjects.Points.PointsPositionControl.CoordinateValue.XYZ) { CoordinateName = " X; Y; Z "; goto ManyCoord; }
        ...
        {//Контроль не заданных значений координат точки//Возвращает метку, соответсвующую координатам, для которых значения координат соответсвуют значению "Nothing"
            ...
            GeomObjects.Points.Point3D Point3DByTextVar = new GeomObjects.Points.Point3D();//Точка для вывода
            PointsPositionControl.CoordinateValue CoordinateValueVar = GeomObjects.Points.PointsPositionControl.CoordinateValue.None;//Исходное значение нумератора
            //Контроль комментария на случай отсутствия внешнего значения (для нескольких координат)
            if (Comment == null) { Point3DByTextVar = this.CreatePoint3DByText(X_Text, Y_Text, Z_Text, CoordinateValueVar, Comment, Comment); ProectionError = CoordinateValueVar; return Point3DByTextVar; }
            else { Point3DByTextVar = this.CreatePoint3DByText(X_Text, Y_Text, Z_Text, CoordinateValueVar); MessageBox.Show(Comment, "Контроль ввода координат", MessageBoxButtons.OK, MessageBoxIcon.Error); }//Расчет точки и метки
        ...
        {//Контроль не заданных значений координат точки//Возвращает метку, соответсвующую координатам, для которых значения координат соответсвуют значению "Nothing"//MsgBoxShow включает или отключает MsgBox
            ...
            //Включение MsgBox
            if (MsgBoxShow == true) { ProectionError = CoordinateValueVar; Point3DByTextVar = this.CreatePoint3DByText(X_Text, Y_Text, Z_Text, CoordinateValueVar, CommentVar, CommentVar); }//Расчет точки и метки c отображением MsgBox
            else { ProectionError = CoordinateValueVar; Point3DByTextVar = this.CreatePoint3DByText(X_Text, Y_Text, Z_Text, CoordinateValueVar); }//Расчет точки и метки без отображения MsgBox
            return Point3DByTextVar;
        }
        ...
        {
            return Math.Sqrt((base.X - x) * (base.X - x) + (base.Y - y) * (base.Y - y) + (this.Z - z) * (this.Z - z));
        }
        ...
        {
            return Math.Sqrt((base.X - pt.X) * (base.X - pt.X) + (base.Y - pt.Y) * (base.Y - pt.Y) + (this.Z - pt.Z) * (this.Z - pt.Z));
        }
