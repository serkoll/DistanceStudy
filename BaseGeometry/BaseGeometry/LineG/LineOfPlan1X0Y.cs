...
namespace GeomObjects.Lines
{
    ...
    public class LineOfPlan1X0Y
    {
        // = Nothing
        private LineDraw LineDraw_Cls = new LineDraw();

        //Базовая точка прямой
        private GeomObjects.Points.PointOfPlan1X0Y Point_0_Cls = new GeomObjects.Points.PointOfPlan1X0Y();
        //Вторая точка прямой
        private GeomObjects.Points.PointOfPlan1X0Y Point_1_Cls = new GeomObjects.Points.PointOfPlan1X0Y();
        ...
        /// <remarks></remarks>
        public LineOfPlan1X0Y(GeomObjects.Points.Point3D Point_0, GeomObjects.Points.Point3D Point_1)
        {
        ...
        /// <summary>Инициализирует новый экземпляр двумерной проекции прямой по заданным проекциям базовой и второй точек</summary>
        /// <remarks></remarks>
        public LineOfPlan1X0Y(GeomObjects.Points.PointOfPlan1X0Y Point_0, GeomObjects.Points.PointOfPlan1X0Y Point_1)
        {
        ...
        /// <remarks></remarks>
        public LineOfPlan1X0Y(Line2D Line_Source)
        {
        ...
        /// <summary>Инициализирует новый экземпляр двумерной проекции точки</summary>
        /// <remarks></remarks>
        public LineOfPlan1X0Y(Line3D Line_Source)
        {
            this.Point_0.X = Line_Source.Point_0.X;
            this.Point_0.Y = Line_Source.Point_0.Y;
            this.Point_1.X = Line_Source.Point_1.X;
        ...
        /// <remarks></remarks>
        public GeomObjects.Points.PointOfPlan1X0Y Point_0
        {
        ...
        /// <remarks></remarks>
        public GeomObjects.Points.PointOfPlan1X0Y Point_1
        {
            // Считывание значения X
        ...
        /// <remarks></remarks>
        public Line2D CnvLine2D(LineOfPlan1X0Y LineProjection)
        {
