...
namespace GeomObjects.Lines
{
    ...
    public static class LinePositionControl
    {
        ...
        public static bool? LinesIsLines(Line2D Line1, Line2D Line2)
        {
            ...
            GeomObjects.Points.Point2D PointLine1_2 = new GeomObjects.Points.Point2D();
        ...
        public static bool? DirectionLine1ToLine2(Line3D Line1, Line3D Line2)
        {
            ...
            dynamic PointLine1 = default(GeomObjects.Points.Point3D);
            GeomObjects.Points.Point3D PointLine2 = new GeomObjects.Points.Point3D();
        ...
        public static bool? LineOfPlan(GeomObjects.Lines.Line3D Line, GeomObjects.Plans.PlaneSpace Plane)
        {
        ...
        /// Контроль осуществляется на основе расчета коэффициентов уравнений прямой и плоскости</remarks>
        public static bool? LineOfPlan(GeomObjects.Lines.Line3D Line, GeomObjects.Plans.PlaneSpace Plane, double SolveError)
        {
            //Функция возвращает "TRUE", если заданная 3D прямая лежит в заданной плоскости
            double s = 0;
            double g = 0;
        ...
        /// <remarks>Точность расчета равна точности задания прямой.
        /// Контроль осуществляется на основе расчета коэффициентов уравнений прямой и плоскости</remarks>
        public static bool? LineToPlanePerpendiculare(GeomObjects.Lines.Line3D Line, GeomObjects.Plans.PlaneSpace Plane)
        {
        ...
        /// <remarks>Позволяет задавать точность расчета.
        /// Контроль осуществляется на основе расчета коэффициентов уравнений прямой и плоскости</remarks>
        public static bool? LineToPlanePerpendiculare(GeomObjects.Lines.Line3D Line, GeomObjects.Plans.PlaneSpace Plane, double SolveError)
        {
            //Функция возвращает "TRUE", если заданная 3D прямая перпендикулярна заданной плоскости
            //Dim LineVar As New BaseGeometryYVP.GeomObjects.Line3D
            //Dim PlaneVar As New BaseGeometryYVP.GeomObjects.Plans.PlaneSpace
